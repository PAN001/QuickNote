    ...
    return function b(a, c, d) {
        ...
        6 : [function(a, b) {
            function c(a, b) {
                ...
                function() {
                    for (var c = arguments,
                    d = -1,
                    f = e(c.length - b, 0), g = Array(f); ++d < f;) g[d] = c[b + d];
                    switch (b) {
                    case 0:
        ...
        14 : [function(a, b) {
            function c(a, b, c, k, l, m, n) {
                for (var o = m.length,
                p = b[c]; o--;) if (m[o] == p) return void(a[c] = n[o]);
                var q = a[c],
        ...
        27 : [function(a, b) {
            function c(a) {
                for (var b = i(a), c = b.length, j = c && a.length, l = !!j && g(j) && (e(a) || d(a) || h(a)), m = -1, n = []; ++m < c;) {
                    var o = b[m]; (l && f(o, j) || k.call(a, o)) && n.push(o)
                }
                return n
            }
        ...
        39 : [function(a, b) {
            function c(a) {
                ...
                d = -1,
                m = g(c) && c.prototype || x, n = m === a, o = Array(b), q = b > 0, r = l.enumErrorProps && (a === w || a instanceof Error), t = l.enumPrototypes && g(a); ++d < b;) o[d] = d + "";
        ...
        44 : [function(a, b) {
            ...
            b.exports = function(a) {
                ...
                for (b = 1; b < arguments.length; ++b) {
                    if (d = g(arguments[b]), k = c(d), f && Object.getOwnPropertySymbols) for (l = Object.getOwnPropertySymbols(d), j = 0; j < l.length; ++j) n = l[j],
                    i(d, n) && h(k, n);
                    for (j = 0; j < k.length; ++j) n = k[j],
                    m = d[n],
                    i(d, n) && (o[n] = m)
                }
                return o
        ...
        46 : [function(a, b) {
            ...
            j = function(a, b, c, d) { (!(b in a) || g(d) && d()) && (i ? Object.defineProperty(a, b, {
                    configurable: !0,
                    enumerable: !1,
                    value: c,
                    writable: !0
        ...
        54 : [function(a, b) {
            ...
            b.exports = function(a) {
                for (var b = "",
                d = 0; d < arguments.length; d++) b += c(a[d]) + (arguments[d + 1] || "");
                return b
            }
        },
        {}],
        55 : [function(a, b) {
            ...
            c(["get", "put", "post", "patch", "head", "delete"],
            function(a) {
        ...
        58 : [function(a, b) {
            ...
            function d(a, b, c) {
                for (var d = 0,
                e = a.length; e > d; d++) i.call(a, d) && b.call(c, a[d], d, a)
            }
            function e(a, b, c) {
                for (var d = 0,
                e = a.length; e > d; d++) b.call(c, a.charAt(d), d, a)
            }
            function f(a, b, c) {
        ...
        66 : [function(a, b, c) {
            ...
            y = function() {
                function a(b, c, d) {
                    if (f(this, a), this.player_ = !b && this.play ? b = this: b, this.options_ = x["default"]({},
                    this.options_), c = this.options_ = x["default"](this.options_, c), this.id_ = c.id || c.el && c.el.id, !this.id_) {
                ...
                a.prototype.emitTapEvents = function() {
                    ...
                    this.on("touchstart",
                    function(c) {
                        1 === c.touches.length && (b = v["default"]({},
                        c.touches[0]), a = (new Date).getTime(), e = !0)
                    }),
                    this.on("touchmove",
                    function(a) {
        ...
        83 : [function(a, b, c) {
            ...
            function(a) {
                ...
                b.prototype.createMenu = function() {
                    for (var a = this,
                    b = this.player_.textTracks() || [], c = void 0, d = this.items = [], e = 0, f = b.length; f > e; e++) {
                        var g = b[e];
        ...
        96 : [function(a, b, c) {
            ...
            v = function(a) {
                function b(c) {
                    ...
                    this.on(this.volumeBar, ["slideractive", "focus"],
                    function() {
                        this.addClass("vjs-slider-active")
                    }),
                    this.on(this.volumeBar, ["sliderinactive", "blur"],
                    function() {
                        this.removeClass("vjs-slider-active")
                    }),
                    this.on(this.volumeBar, ["focus"],
                    function() {
                        this.addClass("vjs-lock-showing")
                    }),
                    this.on(this.volumeBar, ["blur"],
                    function() {
        ...
        100 : [function(a, b, c) {
            ...
            c.__esModule = !0;
            for (var e = a("global/document"), f = d(e), g = {},
        ...
        103 : [function(a, b, c) {
            ...
            t = function(a) {
                ...
                b.prototype.handleSubmenuKeyPress = function(a) { (27 === a.which || 9 === a.which) && (this.buttonPressed_ && this.unpressButton(), 9 !== a.which && a.preventDefault())
                },
        ...
        107 : [function(a, b, c) {
            ...
            function(a) {
                ...
                b.prototype.dimension = function(a, b) {
                    ...
                    if ("" === b) this[c] = void 0;
                        ...
                        var d = parseFloat(b);
                        if (isNaN(d)) return x["default"].error('Improper value "' + b + '" supplied for for ' + a),
                        this;
                        this[c] = d
                    }
                ...
                b.prototype.loadTech_ = function(a, b) {
                    ...
                    "Html5" !== a && this.tag && (_["default"].getTech("Html5").disposeMediaElement(this.tag), this.tag.player = null, this.tag = null),
                    this.techName_ = a,
                    this.isReady_ = !1;
                    var c = L["default"]({
                    ...
                    P["default"].jsonToTextTracks(this.textTracksJson_ || [], this.tech_),
                ...
                b.prototype.unloadTech_ = function() {
                    ...
                    this.textTracksJson_ = P["default"].textTracksToJson(this.tech_),
                    this.isReady_ = !1,
                    this.tech_.dispose(),
                    this.tech_ = !1
                },
                ...
                b.prototype.techGet_ = function(a) {
                    if (this.tech_ && this.tech_.isReady_) try {
                        ...
                        throw void 0 === this.tech_[a] ? x["default"]("Video.js: " + a + " method not defined for " + this.techName_ + " playback technology.", b) : "TypeError" === b.name ? (x["default"]("Video.js: " + a + " unavailable on " + this.techName_ + " playback technology element.", b), this.tech_.isReady_ = !1) : x["default"](b),
                        b
                    }
                },
                ...
                b.prototype.buffered = function c() {
                    ...
                    return c && c.length || (c = A.createTimeRange(0, 0)),
                    c
                },
                ...
                b.prototype.requestFullscreen = function() {
                    ...
                    a.requestFullscreen ? (o.on(k["default"], a.fullscreenchange, s.bind(this,
                    function b() {
                ...
                b.prototype.reset = function() {
                    return this.loadTech_(z["default"](this.options_.techOrder[0]), null),
                ...
                b.getTagSettings = function(a) {
                    ...
                    if (L["default"](b, c), a.hasChildNodes()) for (var h = a.childNodes,
                    i = 0,
                    j = h.length; j > i; i++) {
                        var k = h[i],
            ...
            ba.prototype.handleLoadedMetaData_,
            ba.prototype.handleLoadedData_,
            ba.prototype.handleUserActive_,
            ba.prototype.handleUserInactive_,
            ba.prototype.handleTimeUpdate_,
            ba.prototype.handleTechEnded_,
            ba.prototype.handleVolumeChange_,
            ba.prototype.handleError_,
            ba.prototype.flexNotSupported_ = function() {
            ...
            i["default"].registerComponent("Player", ba),
            c["default"] = ba,
            b.exports = c["default"]
        },
        {
        ...
        112 : [function(a, b, c) {
            ...
            n = function() {
                ...
                e = a.length; e > d; d++) c.push(a[d]);
                if (b && b.length > 0) for (var d = 0,
                e = b.length; e > d; d++) c.push(b[d]);
            ...
            "complete" === i["default"].readyState ? l = !0 : g.one(k["default"], "load",
            function() {
                l = !0
            });
            var p = function() {
            ...
            p = function(a) {
                ...
                b.prototype.update = function() {
                    if (this.el_) {
                        ...
                        b = this.bar;
                        if (b) { ("number" != typeof a || a !== a || 0 > a || a === 1 / 0) && (a = 0);
        ...
        116 : [function(a, b, c) {
            ...
            D = function(a) {
                function b(c, d) {
                    ...
                    this.featuresNativeTextTracks && (this.handleTextTrackChange_ = q.bind(this, this.handleTextTrackChange), this.handleTextTrackAdd_ = q.bind(this, this.handleTextTrackAdd), this.handleTextTrackRemove_ = q.bind(this, this.handleTextTrackRemove), this.proxyNativeTextTracks_()),
                ...
                b.prototype.enterFullScreen = function() {
                    var a = this.el_;
                    "webkitDisplayingFullscreen" in a && this.one("webkitbeginfullscreen",
                    function() {
        ...
        117 : [function(a, b, c) {
            ...
            n = function(a) {
                function b(c, d, f) {
                    ...
                    i = d.playerOptions.techOrder; g < i.length; g++) {
                        var k = m["default"](i[g]),
        ...
        118 : [function(a, b, c) {
            ...
            F = function(a) {
                ...
                b.prototype.trackProgress = function() {
                    this.stopTrackingProgress(),
                    this.progressInterval = this.setInterval(u.bind(this,
                    function() {
                ...
                b.prototype.reset = function() {},
                b.prototype.error = function(a) {
                    return void 0 !== a && (this.error_ = a instanceof A["default"] ? a: new A["default"](a), this.trigger("error")),
                    this.error_
                },
                b.prototype.played = function() {
                ...
                b.prototype.initTextTrackListeners = function() {
                    ...
                    b = this.textTracks();
                    b && (b.addEventListener("removetrack", a), b.addEventListener("addtrack", a), this.on("dispose", u.bind(this,
                    function() {
                ...
                b.prototype.emulateTextTracks = function() {
                    ...
                    if (b) {
                        if (!C["default"].WebVTT && null != this.el().parentNode) {
                            ...
                            c.src = this.options_["vtt.js"] || "https://cdn.rawgit.com/gkatsev/vtt.js/vjs-v0.12.1/dist/vtt.min.js",
                        ...
                        e = function() {
                            ...
                            for (var a = 0; a < b.length; a++) {
                                var c = b[a];
                                c.removeEventListener("cuechange", d),
                                "showing" === c.mode && c.addEventListener("cuechange", d)
                            }
                        };
                        e(),
        ...
        119 : [function(a, b, c) {
            ...
            k = function() {
                function a() {
                    ...
                    for (var e = 0,
                    g = b.length; g > e; e++) c.addTrackElement_(b[e]);
                ...
                a.prototype.getTrackElementByTrack_ = function(a) {
                    for (var b = void 0,
                    c = 0,
                    d = this.trackElements_.length; d > c; c++) if (a === this.trackElements_[c].track) {
                ...
                a.prototype.removeTrackElement_ = function(a) {
                    for (var b = 0,
                    c = this.trackElements_.length; c > b; b++) if (a === this.trackElements_[b]) {
        ...
        121 : [function(a, b, c) {
            ...
            function f(a) {
                var b = this;
                if (h.IS_IE8) {
                    b = j["default"].createElement("custom");
                    for (var c in f.prototype)"constructor" !== c && (b[c] = f.prototype[c])
                }
                return f.prototype.setCues_.call(b, a),
            ...
            i = a("global/document"),
            j = d(i);
            f.prototype.setCues_ = function(a) {
                var b = this.length || 0,
                c = 0,
                d = a.length;
                this.cues_ = a,
            ...
            f.prototype.getCueById = function(a) {
                for (var b = null,
                c = 0,
                d = this.length; d > c; c++) {
                    var e = this[c];
        ...
        125 : [function(a, b, c) {
            ...
            function f(a) {
                var b = this;
                if (l.IS_IE8) {
                    b = n["default"].createElement("custom");
                    for (var c in f.prototype)"constructor" !== c && (b[c] = f.prototype[c])
                }
                a = a || [],
                b.tracks_ = [],
                ...
                return l.IS_IE8 ? b: void 0
            }
            c.__esModule = !0;
            var g = a("../event-target"),
            h = e(g),
            i = a("../utils/fn.js"),
            j = d(i),
            k = a("../utils/browser.js"),
            l = d(k),
            m = a("global/document"),
            n = e(m);
            f.prototype = Object.create(h["default"].prototype),
            ...
            for (var o in f.prototype.allowedEvents_) f.prototype["on" + o] = null;
            f.prototype.addTrack_ = function(a) {
                ...
                a.addEventListener("modechange", j.bind(this,
                function() {
                    this.trigger("change")
                })),
                this.tracks_.push(a),
            ...
            f.prototype.removeTrack_ = function(a) {
                for (var b = void 0,
                c = 0,
                d = this.length; d > c; c++) if (this[c] === a) {
                    b = this[c],
                    b.off && b.off(),
        ...
        126 : [function(a, b, c) {
            ...
            w = function(a) {
                function b(c, d) {
                    ...
                    n.on(this.$(".vjs-done-button"), "click", p.bind(this,
                    function() {
                        this.saveSettings(),
                        this.hide()
                    })),
                    n.on(this.$(".vjs-default-button"), "click", p.bind(this,
                    function() {
        ...
        127 : [function(a, b, c) {
            ...
            function f() {
                ...
                var b = this;
                if (n.IS_IE8) {
                    b = v["default"].createElement("custom");
                    for (var c in f.prototype)"constructor" !== c && (b[c] = f.prototype[c])
                }
                b.tech_ = a.tech;
                var d = p.TextTrackMode[a.mode] || "disabled",
                e = p.TextTrackKind[a.kind] || "subtitles",
                g = a.label || "",
                i = a.language || a.srclang || "",
                k = a.id || "vjs_text_track_" + l.newGUID(); ("metadata" === e || "chapters" === e) && (d = "hidden"),
                b.cues_ = [],
                b.activeCues_ = [];
                var m = new h["default"](b.cues_),
                o = new h["default"](b.activeCues_),
                q = !1,
                r = j.bind(b,
                function() {
                    this.activeCues,
                    q && (this.trigger("cuechange"), q = !1)
                });
                return "disabled" !== d && b.tech_.on("timeupdate", r),
                ...
                Object.defineProperty(b, "mode", {
                    ...
                    set: function(a) {
                        p.TextTrackMode[a] && (d = a, "showing" === d && this.tech_.on("timeupdate", r), this.trigger("modechange"))
                    }
                }),
                ...
                Object.defineProperty(b, "activeCues", {
                    get: function() {
                        ...
                        else for (var c = 0; c < b.length; c++) - 1 === D.call(this.activeCues_, b[c]) && (q = !0);
                ...
                a.src ? (b.src = a.src, C(a.src, b)) : b.loaded_ = !0,
                n.IS_IE8 ? b: void 0
            }
            c.__esModule = !0;
            var g = a("./text-track-cue-list"),
            h = e(g),
            i = a("../utils/fn.js"),
            j = d(i),
            k = a("../utils/guid.js"),
            ...
            z = a("xhr"),
            A = e(z);
            f.prototype = Object.create(t["default"].prototype),
            f.prototype.constructor = f,
            f.prototype.allowedEvents_ = {
                cuechange: "cuechange"
            },
            f.prototype.addCue = function(a) {
                var b = this.tech_.textTracks();
                if (b) for (var c = 0; c < b.length; c++) b[c] !== this && b[c].removeCue(a);
                this.cues_.push(a),
                this.cues.setCues_(this.cues_)
            },
            f.prototype.removeCue = function(a) {
                for (var b = !1,
                c = 0,
                d = this.cues_.length; d > c; c++) {
                    var e = this.cues_[c];
            ...
            var B = function(a, b) {
                var c = new x["default"].WebVTT.Parser(x["default"], x["default"].vttjs, x["default"].WebVTT.StringDecoder());
                c.oncue = function(a) {
                    b.addCue(a)
                },
            ...
            C = function(a, b) {
                ...
                d = y.isCrossOrigin(a);
                d && (c.cors = d),
                A["default"](c, j.bind(this,
                function(a, c, d) {
                    return a ? r["default"].error(a, c) : (b.loaded_ = !0, void("function" != typeof x["default"].WebVTT ? x["default"].setTimeout(function() {
                        B(d, b)
                    },
                    100) : B(d, b)))
                }))
        ...
        129 : [function(a, b, c) {
            ...
            function d(a, b) {
                ...
                for (var g = 0; g < a.length; g++) c = a.start(g),
                d = a.end(g),
                d > b && (d = b),
                f += d - c;
                return f / b
        ...
        142 : [function(b, c, d) {
            ...
            var $ = function ba(a, b, c) {
                var d = void 0;
                if ("string" == typeof a) {
                    if (0 === a.indexOf("#") && (a = a.slice(1)), ba.getPlayers()[a]) return b && H["default"].warn('Player "' + a + '" is already initialised. Options will not be applied.'),
