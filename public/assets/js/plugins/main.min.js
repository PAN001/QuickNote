...
function() {
    ...
    e = $(t),
    n = e.find("#noteInfoCreatedTime"),
    o = e.find("#noteInfoUpdatedTime"),
    i = (e.find("#noteInfoPostUrl"), e.find(".post-url-tr")),
    r = e.find(".post-url-wrap"),
    l = e.find("input"),
    d = e.find(".post-url-base"),
    s = e.find(".post-url-text"),
    a = {
        $noteInfo: $("#noteInfo"),
        note: null,
        bind: function() {
            ...
            e.find(".post-url-pencil").click(function() {
                r.addClass("post-url-edit"),
                l.val(decodeURI(t.note.UrlTitle)),
                l.focus()
            }),
            ...
            l.blur(function() {
                ...
                function(e) {
                    if (reIsOk(e)) {
                        var n = encodeURI(e.Item);
                        t.note.UrlTitle = n,
                        s.text(decodeURI(t.note.UrlTitle))
        ...
        render: function(t) {
            var r = this;
            t || (t = Note.getCurNote()),
            t && (r.note = t, n.html(goNowToDatetime(t.CreatedTime)), o.html(goNowToDatetime(t.UpdatedTime)), t.IsBlog ? (i.removeClass("hide"), d.text(UserInfo.PostUrl + "/"), s.text(decodeURI(t.UrlTitle))) : i.addClass("hide"), r.rendered || (r.$noteInfo.html(e), r.rendered = !0))
        },
        init: function() {
            this.bind()
        }
...
function() {
    ...
    n = {
        ...
        renderContent: function(t) {
            ...
            var o = "<div>",
            n = "</div>";
            this.note.IsMarkdown && (o = "<pre>", n = "</pre>"),
            s.html(o + i + n);
            var a = e.find("a");
        ...
        getHistories: function() {
            ...
            i = Note.getCurNote();
            t.note = i,
            ajaxGet("/noteContentHistory/listHistories", {
...
define("attachment_upload", ["fileupload"],
function() {
    function e(e) {
    ...
    function t(e, t) {
        ...
        function(e) {
            ...
            o ? a.addClass("hover") : a.removeClass("hover"),
    ...
    var a = function() {
        ...
        $("#uploadAttach").fileupload({
            ...
            add: function(a, o) {
                ...
                r.append(o.files[0].name + " <small>[<i>" + e(o.files[0].size) + "</i>]</small>"),
                t.html(r),
                o.context = t;
                var n = o.files[0].size,
                l = +GlobalConfigs.uploadAttachSize || 100;
                if ("number" == typeof n && n > 1048576 * l) return r.find("img").remove(),
                r.removeClass("alert-info").addClass("alert-danger"),
                r.append(" Warning: File size is bigger than " + l + "M"),
                ...
                if (1 == a.result.Ok) a.context.html(""),
                Attach.addAttach(a.result.Item);
                else {
                    a.result;
                    a.context.html("");
                    var o = $('<div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div>');
                    o.append("<b>Error:</b> " + a.files[0].name + " <small>[<i>" + e(a.files[0].size) + "</i>]</small> " + a.result.Msg),
                    a.context.html(o),
            ...
            fail: function(t, a) {
                a.context.html("");
                var o = $('<div class="alert alert-danger"><a class="close" data-dismiss="alert">×</a></div>');
                o.append("<b>Error:</b> " + a.files[0].name + " <small>[<i>" + e(a.files[0].size) + "</i>]</small> " + a.errorThrown),
                a.context.html(o),
                setTimeout(function(e) {
                    return function() {
                        e.remove()
...
var urlPrefix = UrlPrefix;
define("editor_drop_paste", ["fileupload"],
function() {
    function e() {
    ...
    function t(t) {
        ...
        this.container = a,
        this.id = i,
        this.processBar = a.find(".progress-bar")
    }
    function i(e, t) {
        function i(e, i) {
    ...
    function o(e) {
        ...
        r = function(t) {
            function r(e) {
                o.setAttrib(n, "src", t.src),
                t.title && o.setAttrib(n, "title", t.title),
                o.setAttrib(n, "id", null)
            }
            var n, s = {};
            s.id = "__mcenew" + a++,
            s.src = "/images/loading-24.gif",
            n = o.createHTML("img", s),
            tinymce.activeEditor.insertContent(n),
            n = o.get(s.id),
            i(e.src, r)
        },
        n = "";
    ...
    t.prototype.update = function(e) {
        ...
        e >= 100 && (e = 99),
        e += "%",
        $("#" + t.id + " .progress-bar").html(e).css("width", e)
    },
    ...
    r = function() {
        ...
        $("#upload").fileupload({
            ...
            add: function(t, i) {
                ...
                o.find("div").append(i.files[0].name + " <small>[<i>" + e(i.files[0].size) + "</i>]</small>"),
                i.context = o.appendTo(a);
                i.submit()
            },
            done: function(t, i) {
                if (1 == i.result.Ok) {
                    ...
                    r.find("div").append("<b>" + getMsg("Error") + ":</b> " + i.files[0].name + " <small>[<i>" + e(i.files[0].size) + "</i>]</small> " + i.result.Msg),
                    i.context.append(r),
                    setTimeout(function(e) {
                        return function() {
                            e.remove()
            ...
            fail: function(t, i) {
                ...
                o.find("div").append("<b>" + getMsg("Error") + ":</b> " + i.files[0].name + " <small>[<i>" + e(i.files[0].size) + "</i>]</small> " + i.errorThrown),
                i.context.append(o),
                setTimeout(function(e) {
                    return function() {
                        e.remove()
        ...
        function(e) {
            ...
            r ? (o.addClass("hover"), LEA.readOnly && LEA.toggleWriteable()) : o.removeClass("hover"),
            window.dropZoneTimeout = setTimeout(function() {
                window.dropZoneTimeout = null,
                o.removeClass("in hover"),
                i()
            },
            500)
        })
        ...
        if (i.async) {
            ...
            return {
                send: function(s, a) {
                    ...
                    r = e('<iframe src="javascript:false;" name="iframe-transport-' + (t += 1) + '"></iframe>').bind("load",
                    function() {
                        var t, o = e.isArray(i.paramName) ? i.paramName: [i.paramName];
                        r.unbind("load").bind("load",
                        function() {
                            var t;
                            try {
                        ...
                        n.prop("target", r.prop("name")).prop("action", i.url).prop("method", i.type),
                ...
                abort: function() {
                    r && r.unbind("load").prop("src", "javascript".concat(":false;")),
                    n && n.remove()
                }
            }
        }
...
function(e) {
    ...
    e.widget.extend = function(i) {
        for (var r, o, s = n.call(arguments, 1), a = 0, l = s.length; l > a; a++) for (r in s[a]) o = s[a][r],
        s[a].hasOwnProperty(r) && o !== t && (e.isPlainObject(o) ? i[r] = e.isPlainObject(i[r]) ? e.widget.extend({},
        i[r], o) : e.widget.extend({},
        o) : i[r] = o);
        return i
    },
    ...
    e.Widget.prototype = {
        ...
        option: function(i, n) {
            ...
            r = i.split("."), i = r.shift(), r.length) {
                for (o = a[i] = e.widget.extend({},
                this.options[i]), s = 0; s < r.length - 1; s++) o[r[s]] = o[r[s]] || {},
                o = o[r[s]];
        ...
        _trigger: function(t, i, n) {
            ...
            if (n = n || {},
            i = e.Event(i), i.type = (t === this.widgetEventPrefix ? t: this.widgetEventPrefix + t).toLowerCase(), i.target = this.element[0], o = i.originalEvent) for (r in o) r in i || (i[r] = o[r]);
    ...
    function(t, i) {
        e.Widget.prototype["_" + t] = function(n, r, o) {
            ...
            s && e.effects && e.effects.effect[a] ? n[t](r) : a !== t && n[a] ? n[a](r.duration, r.easing, o) : n.queue(function(i) {
                e(this)[t](),
                o && o.call(n[0]),
                i()
            })
...
function(e) {
    ...
    e.widget("blueimp.fileupload", {
        options: {
            ...
            add: function(t, i) { (i.autoUpload || i.autoUpload !== !1 && (e(this).data("blueimp-fileupload") || e(this).data("fileupload")).options.autoUpload) && i.submit()
            },
            processData: !1,
            contentType: !1,
            cache: !1
        ...
        _getFormData: function(t) {
            var i;
            return "function" == typeof t.formData ? t.formData(t.form) : e.isArray(t.formData) ? t.formData: t.formData ? (i = [], e.each(t.formData,
            function(e, t) {
                i.push({
                    name: e,
                    value: t
        ...
        _initXHRData: function(t) {
            ...
            t.contentRange && (t.headers["Content-Range"] = t.contentRange), r) {
                if (e.support.xhrFormDataFileUpload) {
                    if (t.postMessage) i = this._getFormData(t),
                    t.blob ? i.push({
                        name: o,
                        value: t.blob
                    }) : e.each(t.files,
                    function(e, n) {
                        ...
                        t.blob ? (t.headers["Content-Disposition"] = 'attachment; filename="' + encodeURI(n.name) + '"', i.append(o, t.blob, n.name)) : e.each(t.files,
                        function(e, n) { (window.Blob && n instanceof Blob || window.File && n instanceof File) && i.append(t.paramName[e] || o, n, n.name)
                        })
                    }
                    t.data = i
                }
            } else t.headers["Content-Disposition"] = 'attachment; filename="' + encodeURI(n.name) + '"',
            t.contentType = n.type,
            t.data = t.blob || n;
            t.blob = null
        },
        ...
        _getParamName: function(t) {
            ...
            return n ? e.isArray(n) || (n = [n]) : (n = [], i.each(function() {
                for (var t = e(this), i = t.prop("name") || "files[]", r = (t.prop("files") || [1]).length; r;) n.push(i),
                r -= 1
        ...
        _getXHRPromise: function(t, i, n) {
            ...
            t === !0 ? r.resolveWith(i, n) : t === !1 && r.rejectWith(i, n),
            o.abort = r.promise,
        ...
        _addConvenienceMethods: function(e, t) {
            var i = this;
            t.submit = function() {
                return "pending" !== this.state() && (t.jqXHR = this.jqXHR = i._trigger("submit", e, this) !== !1 && i._onSend(e, this)),
        ...
        _chunkedUpload: function(t, i) {
            ...
            return this._isXHRUpload(t) && u && (l || a > p) && !t.data ? i ? !0 : l >= a ? (s.error = "Uploaded bytes exceed file size", this._getXHRPromise(!1, t.context, [null, "error", s.error])) : (r = function() {
                ...
                n = (o._trigger("chunksend", null, i) !== !1 && e.ajax(i) || o._getXHRPromise(!1, i.context)).done(function(n, s, p) {
                    l = o._getUploadedBytes(p) || l + i.chunkSize,
                    i._progress.loaded === h && o._onProgress(e.Event("progress", {
                        lengthComputable: !0,
                    ...
                    a > l ? r() : d.resolveWith(i.context, [n, s, p])
                }).fail(function(e, t, n) {
                    i.jqXHR = e,
                    i.textStatus = t,
                    i.errorThrown = n,
        ...
        _onSend: function(t, i) {
            ...
            p = function() {
                ...
                n = n || ((r || a._trigger("send", t, l) === !1) && a._getXHRPromise(!1, l.context, r) || a._chunkedUpload(l) || e.ajax(l)).done(function(e, t, i) {
                    a._onDone(e, t, i, l)
                }).fail(function(e, t, i) {
                    a._onFail(e, t, i, l)
            ...
            this.options.sequentialUploads || this.options.limitConcurrentUploads && this.options.limitConcurrentUploads <= this._sending ? (this.options.limitConcurrentUploads > 1 ? (o = e.Deferred(), this._slots.push(o), s = o.pipe(p)) : s = this._sequence = this._sequence.pipe(p, p), s.abort = function() {
                return r = [void 0, "abort", "abort"],
                n ? n.abort() : (o && o.rejectWith(l.context, r), p())
            },
        ...
        _onAdd: function(t, i) {
            ...
            if ((p.singleFileUploads || u) && this._isXHRUpload(p)) if (!p.singleFileUploads && u) for (o = [], n = [], s = 0; s < i.files.length; s += u) o.push(i.files.slice(s, s + u)),
            r = d.slice(s, s + u),
            r.length || (r = d),
            n.push(r);
            else n = d;
        ...
        _onChange: function(t) {
            ...
            this._getFileInputFiles(n.fileInput).always(function(e) {
                ...
                i._trigger("change", t, n) !== !1 && i._onAdd(t, n)
            })
        },
        _onPaste: function(t) {
        ...
        _onDrop: function(e) {
            ...
            this._getDroppedFiles(i).always(function(i) {
                n.files = i,
                t._trigger("drop", e, n) !== !1 && t._onAdd(e, n)
            })
        },
...
window.define && define("fileupload", [],
function() {});