...
function(e, t) {
    ...
    function a(n) {
        ...
        for (r = 0; r < n.length; r++) {
            ...
            o = n[r],
            a = o.split(/[.\/]/);
            for (var c = 0; c < a.length - 1; ++c) i[a[c]] === t && (i[a[c]] = {}),
            i = i[a[c]];
            i[a[a.length - 1]] = s[o]
        }
        if (e.AMDLC_TESTS) {
    ...
    te = "tinymce/EditorCommands",
    ne = "tinymce/util/URI",
    re = "tinymce/util/Class",
    ie = "tinymce/util/EventDispatcher",
    oe = "tinymce/data/Binding",
    ae = "tinymce/util/Observable",
    se = "tinymce/data/ObservableObject",
    le = "tinymce/ui/Selector",
    ce = "tinymce/ui/Collection",
    ue = "tinymce/ui/DomUtils",
    de = "tinymce/ui/BoxUtils",
    fe = "tinymce/ui/ClassList",
    he = "tinymce/ui/ReflowQueue",
    pe = "tinymce/ui/Control",
    me = "tinymce/ui/Factory",
    ge = "tinymce/ui/KeyboardNavigation",
    ve = "tinymce/ui/Container",
    ye = "tinymce/ui/DragHelper",
    be = "tinymce/ui/Scrollable",
    Ce = "tinymce/ui/Panel",
    xe = "tinymce/ui/Movable",
    we = "tinymce/ui/Resizable",
    Ee = "tinymce/ui/FloatPanel",
    Ne = "tinymce/ui/Window",
    _e = "tinymce/ui/MessageBox",
    Se = "tinymce/WindowManager",
    ke = "tinymce/ui/Tooltip",
    Te = "tinymce/ui/Widget",
    Re = "tinymce/ui/Progress",
    Ae = "tinymce/ui/Notification",
    Be = "tinymce/NotificationManager",
    De = "tinymce/dom/NodePath",
    Me = "tinymce/util/Quirks",
    Le = "tinymce/EditorObservable",
    Pe = "tinymce/Mode",
    He = "tinymce/Shortcuts",
    Oe = "tinymce/file/Uploader",
    Ie = "tinymce/file/Conversions",
    Fe = "tinymce/file/ImageScanner",
    ze = "tinymce/file/BlobCache",
    We = "tinymce/EditorUpload",
    Ve = "tinymce/caret/CaretUtils",
    Ue = "tinymce/caret/CaretWalker",
    ...
    At = "tinymce/ui/Label",
    Bt = "tinymce/ui/Toolbar",
    Dt = "tinymce/ui/MenuBar",
    Mt = "tinymce/ui/MenuButton",
    Lt = "tinymce/ui/MenuItem",
    Pt = "tinymce/ui/Throbber",
    Ht = "tinymce/ui/Menu",
    Ot = "tinymce/ui/ListBox",
    It = "tinymce/ui/Radio",
    Ft = "tinymce/ui/ResizeHandle",
    zt = "tinymce/ui/SelectBox",
    Wt = "tinymce/ui/Slider",
    Vt = "tinymce/ui/Spacer",
    Ut = "tinymce/ui/SplitButton",
    $t = "tinymce/ui/StackLayout",
    ...
    function() {
        ...
        function o() {
            for (var e = 0,
            t = this._deferreds.length; t > e; e++) n.call(this, this._deferreds[e]);
        ...
        var l = t.immediateFn || "function" == typeof setImmediate && setImmediate ||
        function(e) {
            setTimeout(e, 1)
        },
        c = Array.isArray ||
    ...
    function(e) {
        ...
        function i(r, i, o) {
            ...
            function s() { ("complete" === c.readyState || "interactive" === c.readyState && c.body) && (n(c, "readystatechange", s), a())
            }
            function l() {
                try {
        ...
        function o() {
            ...
            o.unbind = function(e, t, r) {
                ...
                if (i = e[c]) {
                    if (f = s[i], t) {
                        ...
                        for (d in f) a = f[d],
                        n(e, a.fakeName || d, a.nativeHandler, a.capture);
                        f = {}
                    }
                    for (d in f) return o;
                    delete s[i];
            ...
            o.fire = function(t, n, i) {
                ...
                while (t && !i.isPropagationStopped());
                return o
            },
            o.clean = function(e) {
                var t, n, r = o.unbind;
        ...
        return o.Event = new o,
        o.Event.bind(window, "ready",
        function() {}),
        o
    }),
    r(f, [],
    function() {
        ...
        function y(e) {
            ...
            o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = h(function(e) {
                return e === t
            },
            a, !0), c = h(function(e) {
            ...
            }]; i > s; s++) if (n = w.relative[e[s].type]) u = [h(p(u), n)];
            else {
        ...
        B = e.setDocument = function(e) {
            ...
            r = n.defaultView;
            return n !== D && 9 === n.nodeType && n.documentElement ? (D = n, M = n.documentElement, L = !N(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload",
            function() {
                B()
            },
            ...
            H = [], P = [], (x.qsa = ge.test(n.querySelectorAll)) && (i(function(e) {
                ...
                O.call(e, "[s!='']:x"),
                H.push("!=", ae)
            }), P = P.length && new RegExp(P.join("|")), H = H.length && new RegExp(H.join("|")), t = ge.test(M.compareDocumentPosition), I = t || ge.test(M.contains) ?
            function(e, t) {
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    function(e) {
                        ...
                        if (g) {
                            ...
                            else for (; (d = ++h && d && d[m] || (f = h = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v: 1 !== d.nodeType) || !++f || (y && ((d[F] || (d[F] = {}))[e] = [W, f]), d !== t)););
                            return f -= i,
                            f === r || f % r === 0 && f / r >= 0
                        }
                    }
        ...
        _ = e.tokenize = function(t, n) {
            ...
            for (s = t, l = [], c = w.preFilter; s;) { (!r || (i = le.exec(s))) && (i && (s = s.slice(i[0].length) || s), l.push(o = [])),
                r = !1,
    ...
    function() {
        ...
        function i(e, t) {
            var r = [];
            return n(e,
            function(n, i) { (!t || t(n, i, e)) && r.push(n)
            }),
            r
        }
        function o(e, t) {
        ...
        return f.fn = f.prototype = {
            ...
            init: function(e, t) {
                ...
                if (a(e)) {
                    ...
                    if (r[1]) for (i = l(e, v(t)).firstChild; i;) E.call(n, i),
                    i = i.nextSibling;
                    else {
            ...
            prop: function(e, t) {
                var n = this;
                if (e = B[e] || e, "object" == typeof e) m(e,
                function(e, t) {
                    n.prop(e, t)
                });
                else {
    ...
    function() {
        return function(e, t) {
            ...
            u, d, f, h = "\ufeff";
            for (e = e || {},
            t && (d = t.getValidStyles(), f = t.getInvalidStyles()), u = ("\\\" \\' \\; \\: ; : " + h).split(" "), l = 0; l < u.length; l++) c[u[l]] = h + l,
            c[h + l] = u[l];
            return {
                toHex: function(e) {
        ...
        function t(n) {
            ...
            function N(e) {
                ...
                for (t = L[U], i = t.parentNode; i; t = i, i = i.parentNode) {
                    if (i == L[V]) return S(t, e); ++n
                }
                for (t = L[V], i = t.parentNode; i; t = i, i = i.parentNode) {
                    if (i == L[U]) return k(t, e); ++r
                }
                for (o = r - n, a = L[V]; o > 0;) a = a.parentNode,
                o--;
                for (s = L[U]; 0 > o;) s = s.parentNode,
                o++;
            ...
            function _(e) {
                ...
                for (o = C(L[V], L[W]), a = L[$] - L[W]; o && a > 0;) s = o.nextSibling,
                l = D(o, e),
                t && t.appendChild(l),
                --a,
                o = s;
            ...
            function S(e, t) {
                var n, i, o, a, s, l;
                if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = j(e), a = o - L[W], 0 >= a) return t != O && (L.setEndBefore(e), L.collapse(z)),
                n;
            ...
            function k(e, t) {
                var n, i, o, a, s, l;
                for (t != I && (n = r()), o = A(e, t), n && n.appendChild(o), i = j(e), ++i, a = L[$] - i, o = e.nextSibling; o && a > 0;) s = o.nextSibling,
                l = D(o, t),
                n && n.appendChild(l),
                --a,
                o = s;
    ...
    function(e, t) {
        return function(n, r) {
            ...
            function o(r, o, c) {
                ...
                function p() {
                    h(function() {
                        for (var e = n.styleSheets,
                        t, r = e.length,
                        i; r--;) if (t = e[r], i = t.ownerNode ? t.ownerNode: t.owningElement, i && i.id === g.id) return u(),
                        !0
                    },
                    p)
                }
                ...
                s[r] = b), o && b.passed.push(o), c && b.failed.push(c), 1 != b.status) {
                    ...
                    if (b.status = 1, g = n.createElement("link"), g.rel = "stylesheet", g.type = "text/css", g.id = "u" + a++, g.async = !1, g.defer = !1, y = (new Date).getTime(), "onload" in g && !f()) g.onload = p,
                    g.onerror = d;
                    else {
                        if (navigator.userAgent.indexOf("Firefox") > 0) return v = n.createElement("style"),
    ...
    function(e, n, r, i, o, a, s, l, c, u) {
        ...
        return p.prototype = {
            ...
            clone: function(e, t) {
                var n = this,
                r, i;
                return ! b || 1 !== e.nodeType || t ? e.cloneNode(t) : (i = n.doc, t ? r.firstChild: (r = i.createElement(e.nodeName), m(n.getAttribs(e),
                function(t) {
            ...
            getParents: function(e, n, r, i) {
                var o = this,
                a, s = [];
                for (e = o.get(e), i = i === t, r = r || ("BODY" != o.getRoot().nodeName ? o.getRoot().parentNode: null), g(n, "string") && (a = n, n = "*" === n ?
                function(e) {
                    return 1 == e.nodeType
                }: function(e) {
                    return o.is(e, a)
            ...
            loadCSS: function(e) {
                ...
                n = t.doc,
                r;
                return t !== p.DOM && n === document ? void p.DOM.loadCSS(e) : (e || (e = ""), r = n.getElementsByTagName("head")[0], void m(e.split(","),
                function(e) {
                    var i;
            ...
            rename: function(e, t) {
                var n = this,
                r;
                return e.nodeName != t.toUpperCase() && (r = n.create(t), m(n.getAttribs(e),
                function(t) {
                    n.setAttrib(r, t.nodeName, n.getAttrib(e, t.nodeName))
                }), n.replace(r, e, 1)),
                r || e
            ...
            run: function(e, t, n) {
                ...
                e ? (n = n || this, e.nodeType || !e.length && 0 !== e.length ? t.call(n, e) : (i = [], m(e,
                function(e, o) {
    ...
    function(e, t, n, r) {
        ...
        function o(e) {
            this.walk = function(t, n) {
                ...
                f = t.endOffset,
                h, p, m, g, v, y, b;
                if (b = e.select("td[data-mce-selected],th[data-mce-selected]"), b.length > 0) return void s(b,
                function(e) {
                    n([e])
                });
            ...
            this.normalize = function(n) {
                function r(r) {
                    ...
                    function f(n, r) {
                        var a, s, l;
                        if (r = r || h, l = e.getParent(r.parentNode, e.isBlock) || g, n && "BR" == r.nodeName && C && e.isEmpty(l)) return h = r.parentNode,
                        p = e.nodeIndex(r),
                        void(i = !0);
                        for (a = new t(r, l); v = a[n ? "prev": "next"]();) {
                            if ("false" === e.getContentEditableParent(v) || c(v)) return;
                            if (3 === v.nodeType && v.nodeValue.length > 0) return h = v,
                            p = n ? v.nodeValue.length: 0,
                            void(i = !0);
    ...
    function(e, t, n) {
        return function(r) {
            ...
            var o, a = [];
            "onselectionchange" in r.getDoc() || r.on("NodeChange Click MouseUp KeyUp Focus",
            function(t) {
                var n, i;
            ...
            r.on("SelectionChange",
            function() {
                var e = r.selection.getStart(!0); (t.range || !r.selection.isCollapsed()) && !i(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({
                    selectionChange: !0
                })
            }),
            r.on("MouseUp",
            function(e) {
                e.isDefaultPrevented() || ("IMG" == r.selection.getNode().nodeName ? n.setEditorTimeout(r,
                function() {
                    r.nodeChanged()
                }) : r.nodeChanged())
            }),
            this.nodeChanged = function(e) {
                var t = r.selection,
                n, i, o;
                r.initialized && t && !r.settings.disable_nodechange && !r.readonly && (o = r.getBody(), n = t.getStart() || o, n = n.ownerDocument != r.getDoc() ? r.getBody() : n, "IMG" == n.nodeName && t.isCollapsed() && (n = n.parentNode), i = [], r.dom.getParent(n,
                function(e) {
                    return e === o ? !0 : void i.push(e)
                }), e = e || {},
                e.element = n, e.parents = i, r.fire("NodeChange", e))
            }
        }
    }),
    r(A, [],
    ...
    function(e) {
        ...
        function n(e) {
            ...
            var a = {},
            l, c, u, d, f, h;
            return i[e] ? i[e] : (l = t("id accesskey class dir lang style tabindex title"), c = t("address blockquote div dl fieldset form h1 h2 h3 h4 h5 h6 hr menu ol p pre table ul"), u = t("a abbr b bdo br button cite code del dfn em embed i iframe img input ins kbd label map noscript object q s samp script select small span strong sub sup textarea u var #text #comment"), "html4" != e && (l.push.apply(l, t("contenteditable contextmenu draggable dropzone hidden spellcheck translate")), c.push.apply(c, t("article aside details dialog figure header footer hgroup section nav")), u.push.apply(u, t("audio canvas command datalist mark meter output picture progress time wbr video ruby bdi keygen"))), "html5-strict" != e && (l.push("xml:lang"), h = t("acronym applet basefont big font strike tt"), u.push.apply(u, h), s(h,
            function(e) {
                n(e, "", u)
        ...
        return function(e) {
            ...
            function f(e) {
                ...
                if (e) for (e = t(e, ","), y["@"] && (w = y["@"].attributes, E = y["@"].attributesOrder), n = 0, r = e.length; r > n; n++) if (s = S.exec(e[n])) {
                    ...
                    if (f) for (f = t(f, "|"), i = 0, o = f.length; o > i; i++) if (s = k.exec(f[i])) {
                        if (c = {},
                        m = s[1], p = s[2].replace(/::/g, ":"), b = s[3], _ = s[4], "!" === m && (l.attributesRequired = l.attributesRequired || [], l.attributesRequired.push(p), c.required = !0), "-" === m) {
                            delete g[p],
                            v.splice(u(v, p), 1);
                            continue
                        }
            ...
            N = o("whitespace_elements", "pre script noscript style textarea video audio iframe object"),
            ...
            e.valid_elements ? h(e.valid_elements) : (s(E,
            function(e, t) {
                y[t] = {
    ...
    function(e, t, n) {
        ...
        function i(i, a) {
            ...
            l.parse = function(e) {
                ...
                for (P = new RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-_\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), H = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, C = a.getShortEndedElements(), L = i.self_closing_elements || a.getSelfClosingElements(), x = a.getBoolAttrs(), E = i.validate, b = i.remove_internals, W = i.fix_self_closing, O = a.getSpecialElements(); c = P.exec(e);) {
                    ...
                    o(d);
                        ...
                        if (d = d.toLowerCase(), ":" === d.charAt(0) && (d = d.substr(1)), w = d in C, W && L[d] && h.length > 0 && h[h.length - 1].name === d && o(d), !E || (N = a.getElementRule(d))) {
                            if (_ = !0, E && (T = N.attributes, R = N.attributePatterns), (k = c[8]) ? (y = -1 !== k.indexOf("data-mce-type"), y && b && (_ = !1), p = [], p.map = {},
                            k.replace(H, s)) : (p = [], p.map = {}), E && !y) {
                                if (A = N.attributesRequired, B = N.attributesDefault, D = N.attributesForced, M = N.removeEmptyAttrs, M && !p.length && (_ = !1), D) for (m = D.length; m--;) S = D[m],
                                v = S.name,
                                I = S.value,
                                "{$uid}" === I && (I = "mce_" + F++),
                                p.map[v] = I,
                                ...
                                if (B) for (m = B.length; m--;) S = B[m],
                                v = S.name,
                                v in p.map || (I = S.value, "{$uid}" === I && (I = "mce_" + F++), p.map[v] = I, p.push({
                                    name: v,
                                    value: I
                                }));
                                if (A) {
                ...
                for (u < e.length && l.text(z(e.substr(u))), m = h.length - 1; m >= 0; m--) d = h[m],
        ...
        return function(r, l) {
            function c(t) {
                ...
                for (m = i("tr,td,th,tbody,thead,tfoot,table"), p = l.getNonEmptyElements(), g = l.getTextBlockElements(), v = l.getSpecialElements(), n = 0; n < t.length; n++) if (r = t[n], r.parent && !r.fixed) if (g[r.name] && "li" == r.parent.name) {
                    for (y = r.next; y && g[y.name];) y.name = "li",
                    y.fixed = !0,
                    ...
                    if (o && a.length > 1) {
                        for (a.reverse(), s = c = u.filterNode(a[0].clone()), h = 0; h < a.length - 1; h++) {
                            for (l.isValidChild(c.name, a[h].name) ? (d = u.filterNode(a[h].clone()), c.append(d)) : d = c, f = a[h].firstChild; f && f != a[h + 1];) b = f.next,
                            d.append(f),
                            f = b;
                            c = d
                        }
            ...
            u.parse = function(t, o) {
                ...
                h = {},
                p = {},
                T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), H = l.children, k = r.validate, I = "forced_root_block" in o ? o.forced_root_block: r.forced_root_block, P = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, L = /^[ \t\r\n]+$/, v = new n({
                    validate: k,
                    ...
                    start: function(e, t, n) {
                        ...
                        if (o = k ? l.getElementRule(e) : {}) {
                            for (r = u(o.outputName || e, 1), r.attributes = t, r.shortEnded = n, b.append(r), s = H[b.name], s && H[r.name] && !s[r.name] && A.push(r), i = f.length; i--;) a = f[i].name,
                            a in t.map && (_ = p[a], _ ? _.push(r) : p[a] = [r]);
                            T[e] && m(r),
                            n || (b = r),
                            !B && P[e] && (B = !0)
                        }
                        ...
                        if (r = k ? l.getElementRule(t) : {}) {
                            if (T[t] && !B) {
                                ...
                                o = n.next,
                                (0 === i.length || L.test(i)) && (n.remove(), n = o),
                                n = o;
                            ...
                            if (B && P[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O)) if (r.paddEmpty) b.empty().append(new e("#text", "3")).value = "\xa0";
        ...
        return function(t) {
            ...
            l = "html" == t.element_format,
            {
                start: function(e, t, n) {
                    ...
                    r.push(" ", d.name, '="', s(d.value, !0), '"'); ! n || l ? r[r.length] = ">": r[r.length] = " />",
            ...
            i.serialize = function(e) {
                function t(e) {
                    ...
                    if (n) n(e);
                        ...
                        if (s = e.name, l = e.shortEnded, c = e.attributes, a && c && c.length > 1 && (f = [], f.map = {},
                        m = r.getElementRule(e.name))) {
                            for (h = 0, p = m.attributesOrder.length; p > h; h++) u = m.attributesOrder[h],
                            u in c.map && (d = c.map[u], f.map[u] = d, f.push({
                                name: u,
                                value: d
                            }));
                            for (h = 0, p = c.length; p > h; h++) u = c[h].name,
    ...
    function(e, t, n, r, i, o, a, s, l, c) {
        ...
        return function(e, o) {
            ...
            function g() {
                ...
                l,
                c = o.schema;
                for (e = m(e), l = c.getShortEndedElements(); s = t.exec(e);) i = t.lastIndex,
                a = s[0].length,
            ...
            function v(e) { - 1 === l.inArray(p, e) && (C.addAttributeFilter(e,
                function(e, t) {
            ...
            C = new t(e, b),
            C.addAttributeFilter("data-mce-tabindex",
            function(e, t) {
                for (var n = e.length,
                r; n--;) r = e[n],
            ...
            C.addAttributeFilter("src,href,style",
            function(t, n) {
                for (var r = t.length,
                i, o, a = "data-mce-" + n,
                s = e.url_converter,
                ...
                o !== c ? (i.attr(n, o.length > 0 ? o: null), i.attr(a, null)) : (o = i.attributes.map[n], "style" === n ? o = y.serializeStyle(y.parseStyle(o), i.name) : s && (o = s.call(l, o, n, i.name)), i.attr(n, o.length > 0 ? o: null))
            }),
            ...
            C.addAttributeFilter("data-mce-type",
            function(e, t, n) {
                for (var r = e.length,
                i; r--;) i = e[r],
                "bookmark" !== i.attributes.map["data-mce-type"] || n.cleanup || i.remove()
            }),
            C.addNodeFilter("noscript",
            function(e) {
                for (var t = e.length,
                n; t--;) n = e[t].firstChild,
                n && (n.value = r.decode(n.value))
            }),
            C.addNodeFilter("script,style",
            function(e, t) {
                function n(e) {
            ...
            C.addNodeFilter("xml:namespace,input",
            function(e, t) {
                for (var n = e.length,
                r; n--;) r = e[n],
                7 === r.type ? r.remove() : 1 === r.type && ("input" !== t || "type" in r.attributes.map || r.attr("type", "text"))
            }),
            e.fix_list_elements && C.addNodeFilter("ul,ol",
            function(e) {
                for (var t = e.length,
                n, r; t--;) n = e[t],
                r = n.parent,
            ...
            C.addAttributeFilter("data-mce-src,data-mce-href,data-mce-style,data-mce-selected,data-mce-expando,data-mce-type,data-mce-resize",
            function(e, t) {
                for (var n = e.length; n--;) e[n].attr(t, null)
            }),
            {
                ...
                serialize: function(t, n) {
                    ...
                    o.createHTMLDocument && (a = o.createHTMLDocument(""), d("BODY" == t.nodeName ? t.childNodes: [t],
                    function(e) {
    ...
    function(e, t, n, r, i) {
        ...
        return function(i, a) {
            function s(e) {
                ...
                return t === !1 || r.iOS ? !1 : ("string" != typeof t && (t = "table,img,div,iframe"), "false" === e.getAttribute("data-mce-resize") ? !1 : e == a.getBody() ? !1 : a.dom.is(e, t))
            }
            function l(t) {
                var n, r, i, o, s;
                n = t.screenX - B,
                ...
                R[2] < 0 && S.clientWidth <= F && E.setStyle(S, "left", M + (P - F)),
                R[3] < 0 && S.clientHeight <= z && E.setStyle(S, "top", L + (H - z)),
                n = j.scrollWidth - Y,
                r = j.scrollHeight - X,
                n + r !== 0 && E.setStyles(k, {
                    left: o - n,
            ...
            function c() {
                ...
                e("width", F),
                e("height", z),
                E.unbind(W, "mousemove", l),
                E.unbind(W, "mouseup", c),
                V != W && (E.unbind(V, "mousemove", l), E.unbind(V, "mouseup", c)),
                E.remove(S),
                E.remove(k),
                ...
                E.setAttrib(_, "style", E.getAttrib(_, "style")),
                a.nodeChanged()
            }
            function u(e, t, n) {
                var i, o, u, f, h;
                ...
                function(e, i) {
                    function a(t) {
                        ...
                        X = j.scrollHeight,
                        S = _.cloneNode(!0),
                        E.addClass(S, "mce-clonedresizable"),
                        E.setAttrib(S, "data-mce-bogus", "all"),
                        S.contentEditable = !1,
                        S.unSelectabe = !0,
                        E.setStyles(S, {
                            left: M,
                        ...
                        j.appendChild(S),
                        E.bind(W, "mousemove", l),
                        E.bind(W, "mouseup", c),
                        V != W && (E.bind(V, "mousemove", l), E.bind(V, "mouseup", c)),
                        k = E.add(j, "div", {
                    ...
                    }), r.ie && (s.contentEditable = !1), E.bind(s, "mousedown",
                    function(e) {
            ...
            function d() {
                ...
                for (e in T) t = E.get("mceResizeHandle" + e),
                t && (E.unbind(t), E.remove(t))
            }
            function f(e) {
                function t(e, t) {
                    if (e) do
                ...
                var n, r;
                if (!I && !a.removed) return N(E.select("img[data-mce-selected],hr[data-mce-selected]"),
                function(e) {
                    e.removeAttribute("data-mce-selected")
                }),
                r = "mousedown" == e.type ? e.target: i.getNode(),
                r = E.$(r).closest(U ? "table": "table,img,hr")[0],
                t(r, j) && (C(), n = i.getStart(!0), t(n, r) && t(i.getEnd(!0), r) && (!U || r != n && "IMG" !== n.nodeName)) ? void u(r) : void d()
            }
            function h(e, t, n) {
            ...
            function v(e) {
                ...
                if (t != _) {
                    if (a.fire("ObjectSelected", {
                        target: t
                    }), y(), 0 === t.id.indexOf("mceResizeHandle")) return void(e.returnValue = !1); ("IMG" == t.nodeName || "TABLE" == t.nodeName) && (d(), _ = t, h(t, "resizestart", m))
                }
            }
            function y() {
                p(_, "resizestart", m)
            ...
            a.on("init",
            function() {
                U ? (a.on("ObjectResized",
                function(e) {
                    "TABLE" != e.target.nodeName && (d(), x(e.target))
                }), h(j, "controlselect", v), a.on("mousedown",
                function(e) {
                    A = e
                })) : (C(), r.ie >= 11 && (a.on("mousedown click",
                function(e) {
                    var t = e.target.nodeName; ! I && /^(TABLE|IMG|HR)$/.test(t) && (a.selection.select(e.target, "TABLE" == t), "mousedown" == e.type && a.nodeChanged())
                }), a.dom.bind(j, "mscontrolselect",
                function(e) {
                    function t(e) {
                        n.setEditorTimeout(a,
                        function() {
    ...
    function(e, t, n) {
        ...
        function o(e) {
            return c(e) ? t.reduce(e.getElementsByTagName("*"),
            function(e, t) {
                return e || l(t)
            },
            !1) !== !0 : !1
    ...
    function(e, t, n, r, i, o, a) {
        ...
        function c(e) {
            ...
            u,
            f;
            if (v(e.container())) return s(e.container(), e.offset()),
            c;
            if (d(e.container())) if (e.isAtEnd()) f = C(e.container(), e.offset()),
            v(f) && s(f, f.data.length),
            m(f) && !y(f) && i(r(n(f), !1));
            else {
                if (f = C(e.container(), e.offset()), v(f) && s(f, 0), m(f) && e.isAtEnd()) return i(r(n(f), !1)),
                c;
    ...
    function(e, t, n, r, i) {
        ...
        function a(e) {
            return e ? r.reduce(e.childNodes,
            function(e, t) {
        ...
        function m(e, t) {
            var n, o, a;
            return t ? (n = t.split(","), t = n[0].split("/"), a = n.length > 1 ? n[1] : "before", o = r.reduce(t,
            function(e, t) {
            ...
            this.getBookmark = function(e, c) {
                ...
                function f(e) {
                    function t(e, t) {
                        ...
                        i >= s.length && s.length && (u = 1, i = Math.max(0, s.length - 1)),
            ...
            this.moveToBookmark = function(n) {
                ...
                function o(r) {
                    ...
                    if (i && (o = i.parentNode, "start" == r ? (u ? (o = i.firstChild, a = 1) : a = l.nodeIndex(i), f = h = o, p = m = a) : (u ? (o = i.firstChild, a = 1) : a = l.nodeIndex(i), h = o, m = a), !u)) {
                        for (c = i.previousSibling, s = i.nextSibling, t.each(t.grep(i.childNodes),
                        function(e) {
        ...
        return c.prototype = {
            ...
            selectorChanged: function(e, t) {
                ...
                function(e) {
                    ...
                    a = {};
                    u(n.selectorChangedData,
                    function(e, t) {
                        u(o,
                        function(n) {
                            return i.is(n, t) ? (r[t] || (u(e,
                            function(e) {
                                e(!0, {
                                    node: n,
                                    selector: t,
            ...
            scrollIntoView: function(e, t) {
                ...
                if (a.isElement(e)) {
                    if (t === !1 && (d = e.offsetHeight), "BODY" != l.nodeName) {
                        ...
                        if (f) return r = n(e).y - n(f).y + d,
                        u = f.clientHeight,
                        c = f.scrollTop,
                        void((c > r || r + 25 > c + u) && (f.scrollTop = c > r ? r: r - u + 25))
                    }
    ...
    function(e, t, n) {
        ...
        function(r) {
            ...
            l.collapsed || (u = r.selection.getSelectedBlocks(), s(a(a(u, c), i),
            function(e) {
    ...
    function(e, t, n, r, i, o, a) {
        return function(s) {
            ...
            function d(e, t) {
                return j.getParents(e, t, j.getRoot())
            }
            function f(e) {
            ...
            function h() {
                ...
                ce("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/),
                function(e) {
                    g(e, {
                        block: e,
                        remove: "all"
            ...
            function g(e, t) {
                e && ("string" != typeof e ? ce(e,
                function(e, t) {
                    g(t, e)
                }) : (t = t.length ? t: [t], ce(t,
                function(e) {
                    e.deep === ie && (e.deep = !e.selector),
                    e.split === ie && (e.split = !e.selector || e.inline),
                    e.remove === ie && e.selector && !e.inline && (e.remove = "none"),
                    e.selector && e.inline && (e.mixed = !0, e.block_expand = !0),
                    "string" == typeof e.classes && (e.classes = e.classes.split(/\s+/))
                }), q[e] = t))
            }
            function v(e) {
                return e && q[e] && delete q[e],
                q
            }
            function y(e) {
                var t;
                return s.dom.getParent(e,
                function(e) {
            ...
            function b(e) {
                var t;
                1 === e.nodeType && e.parentNode && 1 === e.parentNode.nodeType && (t = y(e.parentNode), s.dom.getStyle(e, "color") && t ? s.dom.setStyle(e, "text-decoration", t) : s.dom.getStyle(e, "text-decoration") === t && s.dom.setStyle(e, "text-decoration", null))
            }
            function C(t, n, r) {
                function i(e, t) {
                    if (t = t || d, e) {
                        if (t.onformat && t.onformat(e, t, n, r), ce(t.styles,
                        function(t, r) {
                            j.setStyle(e, r, M(t, n))
                        }), t.styles) {
                            var i = j.getAttrib(e, "style");
                            i && e.setAttribute("data-mce-style", i)
                        }
                        ce(t.attributes,
                        function(t, r) {
                            j.setAttrib(e, r, M(t, n))
                        }),
                        ce(t.classes,
                        function(t) {
                            t = M(t, n),
                            j.hasClass(e, t) || j.addClass(e, t)
                        })
                    }
                }
                function o() {
                    ...
                    if (i != o && 0 === n.endOffset) {
                        var a = t(i, o),
                        l = 3 == a.nodeType ? a.length: a.childNodes.length;
                        n.setEnd(a, l)
                    }
                    return n
                }
                function c(e, r, o) {
                    ...
                    function(e) {
                        function r(e) {
                            ...
                            1 === e.nodeType && oe(e) && (C = h, h = "true" === oe(e), b = !0),
                            A(m, "br") ? (p = 0, void(d.block && j.remove(e))) : d.wrapper && E(e, t, n) ? void(p = 0) : h && !b && d.block && !d.wrapper && l(m) && K(v, s) ? (e = j.rename(e, s), i(e), a.push(e), void(p = 0)) : d.selector && (ce(u,
                            function(t) {
                                return "collapsed" in t && t.collapsed !== g ? void 0 : j.is(e, t.selector) && !f(e) ? (i(e, t), y = !0, !1) : void 0
                            }), !d.inline || y) ? void(p = 0) : void(!h || b || !K(s, m) || !K(v, s) || !o && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || f(e) || d.inline && G(e) ? (p = 0, ce(ue(e.childNodes), r), b && (h = C), p = 0) : (p || (p = j.clone(c, te), e.parentNode.insertBefore(p, e), a.push(p)), p.appendChild(e)))
                        }
                        var p;
                        ce(e, r)
                    }),
                    ...
                    function(e) {
                        ...
                        function o(e) {
                            ...
                            return ce(e.childNodes,
                            function(e) {
                                return 1 != e.nodeType || le(e) || f(e) ? void 0 : (t = e, te)
                            }),
                            t && !le(t) && R(t, d) && (n = j.clone(t, te), i(n), j.replace(n, e, ne), j.remove(t, 1)),
                            n || e
                        }
                        var s;
                        if (s = r(e), (a.length > 1 || !G(e)) && 0 === s) return void j.remove(e, 1);
                        if (d.inline || d.wrapper) {
                            if (d.exact || 1 !== s || (e = o(e)), ce(u,
                            function(t) {
                                ce(j.select(t.inline, e),
                                function(e) {
                                    le(e) || I(t, n, e, t.exact ? e: null)
                                })
                            }), E(e.parentNode, t, n)) return j.remove(e, 1),
                            e = 0,
                            ne;
                            d.merge_with_parents && j.getParent(e.parentNode,
                            function(r) {
                                return E(r, t, n) ? (j.remove(e, 1), e = 0, ne) : void 0
                            }),
                            e && d.merge_siblings !== !1 && (e = W(z(e), e), e = W(e, z(e, ne)))
                        }
                    })
                }
                var u = m(t),
                ...
                p,
                g = !r && Y.isCollapsed();
                if ("false" !== oe(Y.getNode())) {
                    if (d) {
                        if (r) r.nodeType ? (p = j.createRng(), p.setStartBefore(r), p.setEndAfter(r), c(H(p, u), null, !0)) : c(r, null, !0);
                        else if (g && d.inline && !j.select("td[data-mce-selected],th[data-mce-selected]").length) U("apply", t, n);
                        else {
                            var v = s.selection.getNode();
                            J || !u[0].defaultBlock || j.getParent(v, j.isBlock) || C(u[0].defaultBlock),
                            s.selection.setRng(o()),
                            h = Y.getBookmark(),
                            c(H(Y.getRng(ne), u), h),
                            d.styles && (d.styles.color || d.styles.textDecoration) && (de(v, b, "childNodes"), b(v)),
                            Y.moveToBookmark(h),
                            $(Y.getRng(ne)),
                            s.nodeChanged()
                        }
                    ...
                    r = Y.getNode();
                    for (var y = 0,
                    x = u.length; x > y; y++) if (u[y].ceFalseOverride && j.is(r, u[y].selector)) return void i(r, u[y])
                }
            }
            function x(e, t, n, r) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && oe(e) && (a = b, b = "true" === oe(e), s = !0), n = ue(e.childNodes), b && !s) for (r = 0, o = h.length; o > r && !I(h[r], t, e, e); r++);
                    if (p.deep && n.length) {
                ...
                function o(n) {
                    var i;
                    return ce(d(n.parentNode).reverse(),
                    function(n) {
                        var o;
                ...
                function a(e, n, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
                            for (a = j.clone(o, te), c = 0; c < h.length; c++) if (I(h[c], t, a, a)) {
                                a = 0;
                                break
                            }
                            a && (s && a.appendChild(s), l || (l = a), s = a)
                        } ! i || p.mixed && G(e) || (n = j.split(e, n)),
                ...
                function u(e) {
                    var t = j.get(e ? "_start": "_end"),
                    n = t[e ? "firstChild": "lastChild"];
                    return le(n) && (n = n[e ? "firstChild": "lastChild"]),
                ...
                function f(e) {
                    ...
                    if (e = H(e, h, ne), p.split) {
                        if (t = V(e, ne), n = V(e), t != n) {
                            if (/^(TR|TH|TD)$/.test(t.nodeName) && t.firstChild && (t = "TR" == t.nodeName ? t.firstChild.firstChild || t: t.firstChild || t), r && /^T(HEAD|BODY|FOOT|R)$/.test(r.nodeName) && c(n) && n.firstChild && (n = n.firstChild || n), j.isChildOf(t, n) && !G(n) && !c(t) && !c(n)) return t = P(t, "span", {
                                id: "_start",
                                "data-mce-type": "bookmark"
                            }),
                            l(t),
                    ...
                    function(e) {
                        ...
                        function(e) {
                            i(e),
                            1 === e.nodeType && "underline" === s.dom.getStyle(e, "text-decoration") && e.parentNode && "underline" === y(e.parentNode) && I({
                                deep: !1,
                                exact: !0,
                                inline: "span",
                                styles: {
                ...
                v,
                b = !0;
                if (n) return void(n.nodeType ? (v = j.createRng(), v.setStartBefore(n), v.setEndAfter(n), f(v)) : f(n));
                if ("false" !== oe(Y.getNode())) Y.isCollapsed() && p.inline && !j.select("td[data-mce-selected],th[data-mce-selected]").length ? U("remove", e, t, r) : (g = Y.getBookmark(), f(Y.getRng(ne)), Y.moveToBookmark(g), p.inline && N(e, t, Y.getStart()) && $(Y.getRng(!0)), s.nodeChanged());
                else {
                    n = Y.getNode();
                    for (var C = 0,
                    x = h.length; x > C && (!h[C].ceFalseOverride || !I(h[C], t, n, n)); C++);
                }
            }
            function w(e, t, n) {
                var r = m(e); ! N(e, t, n) || "toggle" in r[0] && !r[0].toggle ? C(e, t, n) : x(e, t, n)
            }
            function E(e, t, n, r) {
                function i(e, t, i) {
                    var o, a, s = t[i],
                    ...
                    if (s) if (s.length === ie) {
                        for (o in s) if (s.hasOwnProperty(o)) {
                            if (a = "attributes" === i ? j.getAttrib(e, o) : B(e, o), r && !a && !t.exact) return;
                            if ((!r || t.exact) && !A(a, D(M(s[o], n), o))) return
                        }
                    } else for (l = 0; l < s.length; l++) if ("attributes" === i ? j.getAttrib(e, s[l]) : B(e, s[l])) return t;
                    return t
                }
                var o = m(t),
                a,
                s,
                l;
                if (o && e) for (s = 0; s < o.length; s++) if (a = o[s], R(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                    if (l = a.classes) for (s = 0; s < l.length; s++) if (!j.hasClass(e, l[s])) return;
                    return a
                }
            }
            function N(e, t, n) {
                function r(n) {
                    var r = j.getRoot();
                    return n === r ? !1 : (n = j.getParent(n,
                    function(n) {
                        return n.parentNode === r || !!E(n, e, t, !0)
                    }), E(n, e, t))
                }
                var i;
                return n ? r(n) : (n = Y.getNode(), r(n) ? ne: (i = Y.getStart(), i != n && r(i) ? ne: te))
            }
            function _(e, t) {
                var n, r = [],
                i = {};
            ...
            function S(e) {
                ...
                o,
                a;
                if (t) for (n = Y.getStart(), r = d(n), o = t.length - 1; o >= 0; o--) {
                    if (a = t[o].selector, !a || t[o].defaultBlock) return ne;
                    for (i = r.length - 1; i >= 0; i--) if (j.is(r[i], a)) return ne
                }
                return te
            }
            function k(e, t, n) {
            ...
            function R(e, t) {
                return A(e, t.inline) ? ne: A(e, t.block) ? ne: t.selector ? 1 == e.nodeType && j.is(e, t.selector) : void 0
            }
            function A(e, t) {
                return e = e || "",
                t = t || "",
            ...
            function B(e, t) {
                return D(j.getStyle(e, t), t)
            }
            function D(e, t) {
                return ("color" == t || "backgroundColor" == t) && (e = j.toHex(e)),
            ...
            function H(t, n, r) {
                function i(e) {
                    ...
                    var r, i, o, a, s;
                    if (r = i = e ? g: y, a = e ? "previousSibling": "nextSibling", s = j.getRoot(), 3 == r.nodeType && !L(r) && (e ? v > 0 : b < r.nodeValue.length)) return r;
                    for (;;) {
                        if (!n[0].block_expand && G(i)) return i;
                        for (o = i[a]; o; o = o[a]) if (!le(o) && !L(o) && !t(o)) return i;
                ...
                function o(e, t) {
                    for (t === ie && (t = 3 === e.nodeType ? e.length: e.childNodes.length); e && e.hasChildNodes();) e = e.childNodes[t],
                ...
                function a(e) {
                    for (var t = e; t;) {
                        if (1 === t.nodeType && oe(t)) return "false" === oe(t) ? t: e;
                        t = t.parentNode
                    }
                    return e
                }
                function c(t, n, i) {
                    ...
                    for (a = new e(t, j.getParent(t, G) || s.getBody()); l = a[i ? "prev": "next"]();) if (3 === l.nodeType) {
                ...
                function u(e, r) {
                    var i, o, a, s;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = d(e), o = 0; o < i.length; o++) for (a = 0; a < n.length; a++) if (s = n[a], !("collapsed" in s && s.collapsed !== t.collapsed) && j.is(i[o], s.selector)) return i[o];
                    return e
                }
                function f(e, t) {
                    var r, i = j.getRoot();
                    if (n[0].wrapper || (r = j.getParent(e, n[0].block, i)), r || (r = j.getParent(3 == e.nodeType ? e.parentNode: e,
                    function(e) {
                        return e != i && l(e)
                    })), r && n[0].wrapper && (r = d(r, "ul,ol").reverse()[0] || r), !r) for (r = e; r[t] && !G(r[t]) && (r = r[t], !A(r, "br")););
                    return r || e
                }
                ...
                y = t.endContainer,
                b = t.endOffset;
                if (1 == g.nodeType && g.hasChildNodes() && (h = g.childNodes.length - 1, g = g.childNodes[v > h ? h: v], 3 == g.nodeType && (v = 0)), 1 == y.nodeType && y.hasChildNodes() && (h = y.childNodes.length - 1, y = y.childNodes[b > h ? h: b - 1], 3 == y.nodeType && (b = y.nodeValue.length)), g = a(g), y = a(y), (le(g.parentNode) || le(g)) && (g = le(g) ? g: g.parentNode, g = g.nextSibling || g, 3 == g.nodeType && (v = 0)), (le(y.parentNode) || le(y)) && (y = le(y) ? y: y.parentNode, y = y.previousSibling || y, 3 == y.nodeType && (b = y.length)), n[0].inline && (t.collapsed && (m = c(g, v, !0), m && (g = m.container, v = m.offset), m = c(y, b), m && (y = m.container, b = m.offset)), p = o(y, b), p.node)) {
                ...
                n[0].selector && n[0].expand !== te && !n[0].inline && (g = u(g, "previousSibling"), y = u(y, "nextSibling")),
                (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (G(g) || (g = i(!0)), G(y) || (y = i()))),
                1 == g.nodeType && (v = Q(g), g = g.parentNode),
                1 == y.nodeType && (b = Q(y) + 1, y = y.parentNode),
                {
                    startContainer: g,
                    startOffset: v,
                    endContainer: y,
            ...
            function I(e, t, n, r) {
                ...
                function(e, i) {
                    ...
                    if (e = M(e, t), "number" == typeof i && (i = e, r = 0), !r || A(j.getAttrib(r, i), e)) {
                        ...
                        function h() {
                            ...
                            Y.moveToBookmark(s);
                                ...
                                for (p = o(), u = p, h = f.length - 1; h >= 0; h--) u.appendChild(j.clone(f[h], !1)),
                                u = u.firstChild;
                                u.appendChild(j.doc.createTextNode(Z)),
                                u = u.firstChild;
                                var g = j.getParent(d, l);
                                g && j.isEmpty(g) ? d.parentNode.replaceChild(p, d) : j.insertAfter(p, d),
                                Y.setCursorLocation(u, 1),
                                j.isEmpty(d) && j.remove(d)
                            }
                        }
                        function p() {
                            var e;
                            ...
                            e && !j.isEmpty(e) && de(e,
                            function(e) {
                                1 != e.nodeType || e.id === g || j.isEmpty(e) || j.setAttrib(e, "data-mce-bogus", null)
                            },
                            "childNodes")
                        }
                        var g = "_mce_caret",
                        v = s.settings.caret_debug; s._hasCaretEvents || (se = function() {
                            var e = [],
                            t;
                            if (a(c(Y.getStart()), e)) for (t = e.length; t--;) j.setAttrib(e[t], "data-mce-bogus", "1")
                        },
                        ae = function(e) {
                            var t = e.keyCode;
                            d(),
                            8 == t && Y.isCollapsed() && Y.getStart().innerHTML == Z && d(c(Y.getStart())),
                            (37 == t || 39 == t) && d(c(Y.getStart())),
                            p()
                        },
                        s.on("SetContent",
                        function(e) {
                    ...
                    function $(t) {
                        ...
                        r = t.startOffset,
                        i, o, a, s, l;
                        if ((t.startContainer != t.endContainer || !u(t.startContainer.childNodes[t.startOffset])) && (3 == n.nodeType && r >= n.nodeValue.length && (r = Q(n), n = n.parentNode, i = !0), 1 == n.nodeType)) for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, j.getParent(n, j.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next()) if (3 == a.nodeType && !L(a)) return l = j.create("a", {
                            "data-mce-bogus": "all"
                        },
                        Z),
                    ...
                    j = s.dom,
                    Y = s.selection,
                    X = new t(j), K = s.schema.isValidChild, G = j.isBlock, J = s.settings.forced_root_block, Q = j.nodeIndex, Z = "\ufeff", ee = /^(src|href|style)$/, te = !1, ne = !0, re, ie, oe = j.getContentEditable, ae, se, le = n.isBookmarkNode, ce = i.each, ue = i.grep, de = i.walk, fe = i.extend; fe(this, {
                        get: m,
                        register: g,
                        unregister: v,
                        apply: C,
                        ...
                        formatChanged: k,
                        getCssText: T
                    }), h(), p(), s.on("BeforeGetContent",
                    function(e) {
                        se && "raw" != e.format && se()
                    }), s.on("mouseup keydown",
                    function(e) {
                        ae && ae(e)
                    })
                }
                ...
                return function(e) {
                    ...
                    function(e) {
                        ...
                        if (!e.isDefaultPrevented()) {
                            ...
                            var n = e.ctrlKey && !e.altKey || e.metaKey; ! (16 > t || t > 20) || 224 == t || 91 == t || o.typing || n || (o.beforeChange(), o.typing = !0, o.add({},
                            e), c = !0)
                        }
                    }),
                    e.on("MouseDown",
                    ...
                    o = {
                        ...
                        add: function(t, i) {
                            ...
                            d;
                            if (t = t || {},
                            t.content = n(), u || e.removed) return null;
                ...
                return function(i) {
                    function o(o) {
                        ...
                        function C(e) {
                            ...
                            if (e || "TABLE" == z ? (n = a.create(e || V), y(n)) : n = L.cloneNode(!1), o = n, l.keep_styles !== !1) do
                            if (s[t.nodeName]) {
                        ...
                        function w(e, t) {
                            ...
                            if (r = a.getParent(e, a.isBlock), !r || !h(r)) {
                                if (r = r || B, c = r == i.getBody() || p(r) ? r.nodeName.toLowerCase() : r.parentNode.nodeName.toLowerCase(), !r.hasChildNodes()) return n = a.create(d),
                                y(n),
                                r.appendChild(n),
                                R.setStart(n, 0),
                                R.setEnd(n, 0),
                                ...
                                if (o && u.isValidChild(c, d.toLowerCase())) {
                                    for (n = a.create(d), y(n), o.parentNode.insertBefore(n, o), s = o; s && !a.isBlock(s);) l = s.nextSibling,
                                    n.appendChild(s),
                                    s = l;
                                    R.setStart(e, t),
                                    R.setEnd(e, t)
            ...
            function(e, n, r, i, o, a) {
                ...
                return function(r) {
                    function g(e, t, n, i) {
                        ...
                        if (a = e.toLowerCase(), o = M.exec[a]) return o(a, t, n),
                        r.fire("ExecCommand", {
                            command: e,
                            ui: t,
                            value: n
                    ...
                    b({
                        ...
                        "InsertUnorderedList,InsertOrderedList": function(e) {
                            var t, n;
                            _(e),
                            t = A.getParent(B.getNode(), "ol,ul"),
                            t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (T(), A.split(n, t), R()))
                        },
                        ...
                        FontSize: function(e, t, n) {
                            var r, i;
                            n >= 1 && 7 >= n && (i = d(L.font_size_style_values), r = d(L.font_size_classes), n = r ? r[n - 1] || n: i[n - 1] || n),
                            k(e, n)
                        },
                        ...
                        mceInsertContent: function(t, n, o) {
                            ...
                            function c(e) {
                                if (N) for (x = e.firstChild; x; x = x.walk(!0)) S[x.name] && x.attr("data-mce-new", "true")
                            }
                            function u() {
                                if (N) {
                                    var e = r.getBody(),
                                    t = new i(A);
                                    s(A.select("*[data-mce-new]"),
                                    function(n) {
                            ...
                            function d(e) {
                                ...
                                var n;
                                if (e) {
                                    if (B.scrollIntoView(e), n = t(e)) return A.remove(e),
                                    void B.select(n);
                                    C = A.createRng(),
                                    x = e.previousSibling,
                                    x && 3 == x.nodeType ? (C.setStart(x, x.nodeValue.length), f || (w = e.nextSibling, w && 3 == w.nodeType && (x.appendData(w.data), w.parentNode.removeChild(w)))) : (C.setStartBefore(e), C.setEndBefore(e)),
                                    A.remove(e),
                                    B.setRng(C)
                                }
                            }
                            var h, p, m, g, v, y, b, C, x, w, E, N, _, S = r.schema.getTextInlineElements();
                            "string" != typeof o && (N = o.merge, _ = o.data, o = o.content),
                            /^ | $/.test(o) && (o = a(o)),
                            h = r.parser,
                            p = new e({
                                validate: L.validate
                            ...
                            r.schema),
                            E = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>',
                            y = {
                                content: o,
                                format: "html",
                                selection: !0
                            },
                            r.fire("BeforeSetContent", y),
                            o = y.content,
                            ...
                            T = r.getBody();
                            k === T && B.isCollapsed() && A.isBlock(T.firstChild) && A.isEmpty(T.firstChild) && (C = A.createRng(), C.setStart(T.firstChild, 0), C.setEnd(T.firstChild, 0), B.setRng(C)),
                            B.isCollapsed() || (r.selection.setRng(r.selection.getRng()), r.getDoc().execCommand("Delete", !1, null), l()),
                            m = B.getNode();
                            var R = {
                                context: m.nodeName.toLowerCase(),
                                data: _
                            };
                            if (v = h.parse(o, R), c(v), x = v.lastChild, "mce_marker" == x.attr("id")) for (b = x, x = x.prev; x; x = x.walk(!0)) if (3 == x.type || !A.isBlock(x.name)) {
                            ...
                            if (r._selectionOverrides.showBlockCaretContainer(m), R.invalid) {
                                for (B.setContent(E), m = B.getNode(), g = r.getBody(), 9 == m.nodeType ? m = x = g: x = m; x !== g;) m = x,
                                x = x.parentNode;
                                o = m == g ? g.innerHTML: A.getOuterHTML(m),
                                o = p.serialize(h.parse(o.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i,
                                function() {
                                    return p.serialize(v)
                                }))),
                                m == g ? A.setHTML(g, o) : A.setOuterHTML(m, o)
                            } else o = p.serialize(v),
                            x = m.firstChild,
                            w = m.lastChild,
                            !x || x === w && "BR" === x.nodeName ? A.setHTML(m, o) : B.setContent(o);
                            u(),
                            d(A.get("mce_marker")),
                            r.fire("SetContent", y),
                            r.addVisual()
                        ...
                        "Indent,Outdent": function(e) {
                            ...
                            n = /[a-z%]+$/i.exec(t),
                            t = parseInt(t, 10),
                            v("InsertUnorderedList") || v("InsertOrderedList") ? _(e) : (L.forced_root_block || A.getParent(B.getNode(), A.isBlock) || D.apply("div"), s(B.getSelectedBlocks(),
                            function(o) {
                                if ("false" !== A.getContentEditable(o) && "LI" != o.nodeName) {
                                    var a = r.getParam("indent_use_margin", !1) ? "margin": "padding";
                                    a += "rtl" == A.getStyle(o, "direction", !0) ? "Right": "Left",
                                    "outdent" == e ? (i = Math.max(0, parseInt(o.style[a] || 0, 10) - t), A.setStyle(o, a, i ? i + n: "")) : (i = parseInt(o.style[a] || 0, 10) + t + n, A.setStyle(o, a, i))
                                }
                            }))
                        },
                        mceRepaint: function() {},
                        ...
                        mceInsertLink: function(e, t, n) {
                            ...
                            r = A.getParent(B.getNode(), "a"),
                            n.href = n.href.replace(" ", "%20"),
                            r && n.href || D.remove("link"),
                            n.href && D.apply("link", n, r)
                        },
                        selectAll: function() {
                            var e = A.getRoot(),
                            t;
                        ...
                        InsertLineBreak: function(e, t, n) {
                            function i() {
                                for (var e = new a(m, v), t, n = r.schema.getNonEmptyElements(); t = e.next();) if (n[t.nodeName.toLowerCase()] || t.length > 0) return ! 0
                            }
                            var s = n,
                            l, c, u, d = B.getRng(!0);
                            new o(A).normalize(d);
                            ...
                            if (1 == m.nodeType && m.hasChildNodes()) {
                                ...
                                m = m.childNodes[Math.min(f, m.childNodes.length - 1)] || m,
                                f = g && 3 == m.nodeType ? m.nodeValue.length: 0
                            }
                            ...
                            x = s && s.ctrlKey;
                            "LI" != C || x || (v = b, y = C),
                            m && 3 == m.nodeType && f >= m.nodeValue.length && (h || i() || (l = A.create("br"), d.insertNode(l), d.setStartAfter(l), d.setEndAfter(l), c = !0)),
                            l = A.create("br"),
                            d.insertNode(l);
                            var w = A.doc.documentMode;
                            return h && "PRE" == y && (!w || 8 > w) && l.parentNode.insertBefore(A.doc.createTextNode("\r"), l),
                            u = A.create("span", {},
                            "&nbsp;"),
                    ...
                    b({
                        "FontSize,FontName": function(e) {
                            var t = 0,
                            n;
                            return (n = A.getParent(B.getNode(), "span")) && (t = "fontsize" == e ? n.style.fontSize: n.style.fontFamily.replace(/, /g, ",").replace(/[\'\"]/g, "").toLowerCase()),
                            t
                        }
                    },
                    "value"),
            ...
            function(e, t, n, r) {
                ...
                return n.extend({
                    ...
                    init: function(t) {
                        ...
                        t = t || {};
                        for (n in t) r = t[n],
                        r instanceof e && (t[n] = r.create(this, n));
                        this.data = t
                    },
                    set: function(t, n) {
            ...
            function(e, t, n) {
                ...
                e.each("fire on off show hide append prepend before after reflow".split(" "),
                function(t) {
                    i[t] = function() {
            ...
            r(pe, [re, m, ie, se, ce, ue, g, de, fe, he],
            function(e, t, n, r, i, o, a, s, l, c) {
                function u(e) {
                    ...
                    function r(t) {
                        ...
                        if (n !== r) {
                            if (c._lastHoverCtrl = n, a = n.parents().toArray().reverse(), a.push(n), r) {
                                ...
                                for (o = s.length - 1; o >= i; o--) r = s[o],
                                r.fire("mouseleave", {
                                    target: r.getEl()
                                })
                            }
                            for (o = i; o < a.length; o++) n = a[o],
                            n.fire("mouseenter", {
                                target: n.getEl()
                            })
                        }
                ...
                v = {
                    ...
                    init: function(e) {
                        ...
                        t.each("title text name visible disabled active value".split(" "),
                        function(t) {
                            t in e && i[t](e[t])
                        }),
                        i.on("click",
                    ...
                    fire: function(e, t, n) {
                        var r = this;
                        if (t = t || {},
                        t.control || (t.control = r), t = u(r).fire(e, t), n !== !1 && r.parent) for (var i = r.parent(); i && !t.isPropagationStopped();) i.fire(e, t, !1),
                        i = i.parent();
                        return t
                    },
                    hasEventListeners: function(e) {
                ...
                return t.each("text title visible disabled active value".split(" "),
                function(e) {
                    v[e] = function(t) {
            ...
            function(e, t, n, r, i, o) {
                ...
                function f(e, t) {
                    ...
                    if (y.length) for (n = 0; n < y.length; n++) y[n].modal && (r++, o = y[n]),
            ...
            function(e, t, n, r, i, o, a, s) {
                ...
                function u() {
                    function e() {
                        ...
                        r;
                        for (e = 0; e < d.length; e++) r = d[e].layoutRect(),
                        d[e].moveTo(d[e].settings.x || Math.max(0, t.w / 2 - r.w / 2), d[e].settings.y || Math.max(0, t.h / 2 - r.h / 2))
                    }
                    var t = {
                        w: window.innerWidth,
                    ...
                    s.setInterval(function() {
                        ...
                        n = window.innerHeight; (t.w != e || t.h != n) && (t = {
                            w: e,
                            h: n
                        },
                ...
                h = e.extend({
                    ...
                    init: function(e) {
                        ...
                        e.buttons && (n.statusbar = new t({
                            ...
                            items: e.buttons
                        }), n.statusbar.classes.add("foot"), n.statusbar.parent(n)),
                        n.on("click",
                    ...
                    fullscreen: function(e) {
                        ...
                        a, l = t.classPrefix,
                        c;
                        if (e != t._fullscreen) if (r(window).on("resize",
                        function() {
                            var e;
                        ...
                        } else t.borderBox = o.parseBox(t.settings.border),
            ...
            function(e, t) {
                var n, r = e.extend({
                    ...
                    bindStates: function() {
                        ...
                        var n = this;
                        return n.state.on("change:disabled",
                        function(t) {
                            e(t.value)
                        }),
                        n.state.on("change:active",
                        function(e) {
                            t(e.value)
                        }),
            ...
            function(e) {
                return e.extend({
                    ...
                    bindStates: function() {
                        ...
                        var t = this;
                        return t.state.on("change:value",
                        function(t) {
                            e(t.value)
                        }),
                        e(t.state.get("value")),
            ...
            function(e, t, n, r, i, o, a, s, l, c) {
                return function(u) {
                    ...
                    function v() {
                        ...
                        function c(e) {
                            var n, r, i, o, s;
                            if (!e.collapsed && (n = C.getParent(t.getNode(e.startContainer, e.startOffset), C.isBlock), r = C.getParent(t.getNode(e.endContainer, e.endOffset), C.isBlock), s = u.schema.getTextBlockElements(), n != r && s[n.nodeName] && s[r.nodeName] && "false" !== C.getContentEditable(n) && "false" !== C.getContentEditable(r))) return e.deleteContents(),
                            i = a(n, !1),
                            o = a(r, !0),
                            C.isEmpty(r) || X(n).append(r.childNodes),
                            X(r).remove(),
                            i ? 1 == i.nodeType ? "BR" == i.nodeName ? (e.setStartBefore(i), e.setEndBefore(i)) : (e.setStartAfter(i), e.setEndAfter(i)) : (e.setStart(i, i.data.length), e.setEnd(i, i.data.length)) : o && (1 == o.nodeType ? (e.setStartBefore(o), e.setEndBefore(o)) : (e.setStart(o, 0), e.setEnd(o, 0))),
                            x.setRng(e),
                            !0
                        }
                        function d(e, n) {
                        ...
                        function v(e, t) {
                            ...
                            if (t.collapsed && (f = t.startContainer, h = t.startOffset, a = C.getParent(f, C.isBlock), i(a))) if (1 == f.nodeType) {
                                ...
                                if (d = e ? a.nextSibling: a.previousSibling, C.isEmpty(a) && i(d) && C.isEmpty(d) && n(a, f)) return C.remove(d),
                                !0
                        ...
                        function y(e) {
                            var t, n, r;
                            f(e) || (s.each(u.getBody().getElementsByTagName("*"),
                            function(e) {
                            ...
                            }), u.getDoc().execCommand(e ? "ForwardDelete": "Delete", !1, null), n = u.selection.getRng(), r = n.startContainer.parentNode, s.each(t.takeRecords(),
                            function(e) {
                            ...
                            }), t.disconnect(), s.each(u.dom.select("span[mce-data-marked]"),
                            function(e) {
                        ...
                        function(t) {
                            if (!h(t) && !x.isCollapsed() && t.charCode > 31 && !e.metaKeyPressed(t)) {
                                ...
                                t.preventDefault(),
                                r = X(n.startContainer).parents().filter(function(e, t) {
                                    return !! u.schema.getTextInlineElements()[t.nodeName]
                                }),
                                y(!0),
                        ...
                        function(e) {
                            if (!h(e)) {
                                var n = m(e);
                                n && (e.preventDefault(), l.setEditorTimeout(u,
                                function() {
                    ...
                    function y() {
                        ...
                        function(e) {
                            ...
                            if (!h(e) && (t == G || t == K)) {
                                ...
                                e.preventDefault(),
                                u.setContent(""),
                                i.firstChild && J.isBlock(i.firstChild) ? u.selection.setCursorLocation(i.firstChild, 0) : u.selection.setCursorLocation(i, 0),
                                u.nodeChanged()
                            }
                        })
                    }
                    ...
                    function C() {
                        u.settings.content_editable || J.bind(u.getDoc(), "mousedown mouseup",
                        function(e) {
                            var t;
                        ...
                        function(e) {
                            if (!h(e) && e.keyCode === K) {
                                ...
                                if (Q.isCollapsed() && 0 === Q.getRng(!0).startOffset) {
                                    var t = Q.getNode(),
                                    n = t.previousSibling;
                                    if ("HR" == t.nodeName) return J.remove(t),
                    ...
                    function w() {
                        window.Range.prototype.getClientRects || u.on("mousedown",
                        function(e) {
                    ...
                    function E() {
                        ...
                        function(e) {
                            var t = e.target;
                            /^(IMG|HR)$/.test(t.nodeName) && "false" !== J.getContentEditableParent(t) && (e.preventDefault(), Q.getSel().setBaseAndExtent(t, 0, t, 1), u.nodeChanged()),
                            "A" == t.nodeName && J.hasClass(t, "mce-item-anchor") && (e.preventDefault(), Q.select(t))
                        })
                    }
                    function N() {
                        function e() {
                            ...
                            return function() {
                                var t = Q.getStart();
                                t !== u.getBody() && (J.setAttrib(t, "style", null), Y(e,
                                function(e) {
                        ...
                        J.bind(u.getDoc(), "cut",
                        function(n) {
                            var r; ! h(n) && t() && (r = e(), l.setEditorTimeout(u,
                            function() {
                                r()
                            }))
                        })
                    ...
                    function k() {
                        f() > 7 || (d("RespectVisibilityInDesign", !0), u.contentStyles.push(".mceHideBrInPre pre br {display: none}"), J.addClass(u.getBody(), "mceHideBrInPre"), ee.addNodeFilter("pre",
                        function(e) {
                            for (var t = e.length,
                            n, r, o, a; t--;) for (n = e[t].getAll("br"), r = n.length; r--;) o = n[r],
                            a = o.prev,
                            a && 3 === a.type && "\n" != a.value.charAt(a.value - 1) ? a.value += "\n": o.parent.insert(new i("#text", 3), o, !0).value = "\n"
                        }), te.addNodeFilter("pre",
                        function(e) {
                            for (var t = e.length,
                    ...
                    function A() {
                        function e() {
                            ...
                            Z.object_resizing || d("enableObjectResizing", !1)
                        }
                    ...
                    function L() {
                        var e;
                        f() >= 10 && (e = "", Y("p div h1 h2 h3 h4 h5 h6".split(" "),
                        function(t, n) {
                            e += (n > 0 ? ",": "") + t + ":empty"
                        }), u.contentStyles.push(e + "{padding-right: 1px !important}"))
                    }
                    function P() {
                        f() < 9 && (ee.addNodeFilter("noscript",
                        function(e) {
                            for (var t = e.length,
                            n, r; t--;) n = e[t],
                            r = n.firstChild,
                            r && n.attr("data-mce-innertext", r.value)
                        }), te.addNodeFilter("noscript",
                        function(e) {
                            for (var t = e.length,
                            n, r, a; t--;) n = e[t],
                            r = e[t].firstChild,
                            r ? r.value = o.decode(r.value) : (a = n.attributes.map["data-mce-innertext"], a && (n.attr("data-mce-innertext", null), r = new i("#text", 3), r.value = a, r.raw = !0, n.append(r)))
                        }))
                    }
                    function H() {
                        function e(e, t) {
                        ...
                        function n() {
                            ...
                            J.unbind(r, "mouseup", n),
                            J.unbind(r, "mousemove", t),
                            a = o = 0
                        }
                        var r = J.doc,
                        i = r.body,
                        ...
                        J.bind(r, "mousedown contextmenu",
                        function(i) {
                            if ("HTML" === i.target.nodeName) {
                                if (o && n(), s = r.documentElement, s.scrollHeight > s.clientHeight) return;
                                o = 1,
                                a = e(i.x, i.y),
                                a && (J.bind(r, "mouseup", n), J.bind(r, "mousemove", t), J.getRoot().focus(), a.select())
                            }
                        })
                    }
                    function O() {
                        u.on("keyup focusin mouseup",
                        function(t) {
                    ...
                    function W() {
                        a.mac && u.on("keydown",
                        function(t) { ! e.metaKeyPressed(t) || t.shiftKey || 37 != t.keyCode && 39 != t.keyCode || (t.preventDefault(), u.selection.getSel().modify("move", 37 == t.keyCode ? "backward": "forward", "lineboundary"))
                        })
                    }
                    function V() {
                        d("AutoUrlDetect", !1)
                    ...
                    y(),
                    a.windowsPhone || O(),
                    ie && (v(), C(), E(), D(), $(), S(), q(), a.iOS ? (F(), z(), U()) : b()),
                    re && a.ie < 11 && (x(), _(), k(), T(), M(), L(), P(), H()),
                    a.ie >= 11 && (z(), S()),
                    a.ie && (b(), V(), j()),
                    ne && (x(), w(), N(), A(), B(), I(), W(), S())
                }
            ...
            function(e, t, n) {
                ...
                function i(e, t) {
                    ...
                    if (e.delegates || (e.delegates = {}), !e.delegates[t]) if (e.settings.event_root) {
                        ...
                        s = function(r) {
                            for (var i = r.target,
                            a = e.editorManager.editors,
                            s = a.length; s--;) {
                                var l = a[s].getBody(); (l === i || o.isChildOf(i, l)) && n(a[s]) && a[s].fire(t, r)
                            }
                        },
                        a[t] = s,
                        o.bind(i, t, s)
            ...
            function(e, t) {
                ...
                return function(a) {
                    ...
                    var l = this,
                    c = {};
                    a.on("keyup keypress keydown",
                    function(e) { (e.altKey || e.ctrlKey || e.metaKey) && !e.isDefaultPrevented() && n(c,
                        function(t) {
            ...
            function(e, t, n, r, i) {
                ...
                return function(a) {
                    function s(s, c) {
                        ...
                        d = t.filter(s.getElementsByTagName("img"),
                        function(e) {
                            var t = e.src;
            ...
            function(e, t, n, r) {
                return function(i) {
                    ...
                    function a(e, t, n) {
                        var r = 0;
                        do r = e.indexOf(t, r),
                        -1 !== r && (e = e.substring(0, r) + n + e.substr(r + t.length), r += n.length - t.length + 1);
                        while ( - 1 !== r);
                        return e
                    }
                    function s(e, t, n) {
                    ...
                    function p(t) {
                        ...
                        function(t, n) {
                            var r = m.getByUri(n);
                            return r || (r = e.reduce(i.editorManager.editors,
                            function(e, t) {
            ...
            function(e, t, n, r, i, o) {
                ...
                function v(e, t, r) {
                    ...
                    if (n.isText(a)) {
                        ...
                        if (s === a.data.length) return o = u(a),
                        o ? S(o) : r;
                        if (0 === s) return o = c(a),
                        o ? k(o) : r
                    }
            ...
            function(e, t, n, r, i, o, a) {
                ...
                return function(t, n) {
                    ...
                    function l() {
                        var n, r, o, a, s;
                        for (n = i("*[contentEditable=false]", t), a = 0; a < n.length; a++) r = n[a],
                        o = r.previousSibling,
                        e.endsWithCaretContainer(o) && (s = o.data, 1 == s.length ? o.parentNode.removeChild(o) : o.deleteData(s.length - 1, 1)),
                        o = r.nextSibling,
                        e.startsWithCaretContainer(o) && (s = o.data, 1 == s.length ? o.parentNode.removeChild(o) : o.deleteData(0, 1));
                        return null
                    }
                    function c(o, a) {
                        var l, c, f;
            ...
            function(e, t, n) {
                function r(i) {
                    ...
                    if (e.isArray(i)) return e.reduce(i,
                    function(e, t) {
                        return e.concat(r(t))
                    },
                    []);
            ...
            function(e, t, n, r, i, o, a) {
                ...
                function d(e, n) {
                    function o(e, i) {
                        var o;
                        return o = t.filter(r.getClientRects(i),
                        function(t) {
                            return ! e(t, n)
                        }),
                        a = a.concat(o),
            ...
            function(e, t, n) {
                function r(e) {
                    ...
                    function s(t) {
                        return t == g.element || e.dom.isChildOf(t, g.element) ? !1 : i(t) ? !1 : !0
                    }
                    function l(t) {
                        var n, r, i, o, s = 0,
                        l = 0,
                    ...
                    function c() {
                        g.dragging && (e.selection.setRng(e.selection.getSel().getRangeAt(0)), s(e.selection.getNode()) && e.undoManager.transact(function() {
                            e.insertContent(m.getOuterHTML(g.element)),
                            f(g.element).remove()
                        })),
                        d()
                    }
                    ...
                    e.on("drop",
                    function(t) {
                        var n = e.getDoc().elementFromPoint(t.clientX, t.clientY); (i(n) || i(e.dom.getContentEditableParent(n))) && t.preventDefault()
                    })
                }
            ...
            r(Ke, [h, Ue, $, k, Ve, $e, je, Ye, _, T, V, I, z, p, u, Xe],
            function(e, t, n, r, i, o, a, s, l, c, u, d, f, h, p, m) {
                function g(e, t) {
                ...
                function v(c) {
                    ...
                    function k(e, t, n) {
                        ...
                        r.isDefaultPrevented() ? null: (S(t, -1 === e), ee.show(n, t))
                    }
                    function T(e) {
                        var t;
                        ...
                        t.isDefaultPrevented() ? null: (ee.hide(), R(e))
                    }
                    function R(e) {
                    ...
                    function B(e, t) {
                        return t = i.normalizeRange(e, G, t),
                    ...
                    function M(e, t, n, r) {
                        var i, o, a, s;
                        return ! r.collapsed && (i = N(r), C(i)) ? k(e, i, -1 == e) : (s = D(r), o = B(e, r), n(o) ? T(o.getNode( - 1 == e)) : (o = t(o)) ? n(o) ? k(e, o.getNode( - 1 == e), 1 == e) : (a = t(o), n(a) && A(o, a) ? k(e, a.getNode( - 1 == e), 1 == e) : s ? W(o.toRange()) : null) : s ? r: null)
                    }
                    function L(e, t, n) {
                        var r, i, o, l, c, u, d, f, p;
                        if (p = N(n), r = B(e, n), i = t(G, a.isAboveLine(1), r), o = h.filter(i, a.isLine(1)), c = h.last(r.getClientRects()), E(r) && (p = r.getNode()), w(r) && (p = r.getNode(!0)), !c) return null;
                        if (u = c.left, l = s.findClosestClientRect(o, u), l && C(l.node)) return d = Math.abs(u - l.left),
                        f = Math.abs(u - l.right),
                        k(e, l.node, f > d);
                        if (p) {
                            var m = a.positionsUntil(e, G, a.isAboveLine(1), p);
                            if (l = s.findClosestClientRect(h.filter(m, a.isLine(1)), u)) return W(l.position.toRange());
                            if (l = h.last(h.filter(m, a.isLine(0)))) return W(l.position.toRange())
                        }
                    }
                    function P(t, r) {
                        function i() {
                        ...
                        if (r.collapsed && c.settings.forced_root_block) {
                            ...
                            a = 1 == t ? Q(n.fromRangeStart(r)) : Z(n.fromRangeStart(r)),
                            a || (s = i(), 1 == t ? c.$(o).after(s) : c.$(o).before(s), c.selection.select(s, !0), c.selection.collapse())
                        }
                    }
                    function H(e, t, n, r) {
                        var i;
                        return (i = M(e, t, n, r)) ? i: (i = P(e, r), i ? i: null)
                    }
                    function O(e, t, n) {
                        var r;
                        return (r = L(e, t, n)) ? r: (r = P(e, n), r ? r: null)
                    }
                    function I() {
                        return re("*[data-mce-caret]")[0]
                    }
                    function F(e) {
                        e = re(e),
                        e.attr("data-mce-caret") && (ee.hide(), e.removeAttr("data-mce-caret"), e.removeAttr("data-mce-bogus"), e.removeAttr("style"), v(_()), S(e[0]))
                    }
                    function z(e) {
                        var t;
                        return e = i.normalizeRange(1, G, e),
                        t = n.fromRangeStart(e),
                        C(t.getNode()) ? k(1, t.getNode(), !t.isAtEnd()) : C(t.getNode(!0)) ? k(1, t.getNode(!0), !1) : (ee.hide(), null)
                    }
                    function W(e) {
                        var t;
                        return e && e.collapsed ? (t = z(e), t ? t: e) : e
                    }
                    function V(e) {
                        var t, i, o, a;
                        return C(e) ? (C(e.previousSibling) && (o = e.previousSibling), i = Z(n.before(e)), i || (t = Q(n.after(e))), t && x(t.getNode()) && (a = t.getNode()), r.remove(e.previousSibling), r.remove(e.nextSibling), c.dom.remove(e), X(), c.dom.isEmpty(c.getBody()) ? (c.setContent(""), void c.focus()) : o ? n.after(o).toRange() : a ? n.before(a).toRange() : i ? i.toRange() : t ? t.toRange() : null) : null
                    }
                    function U(e, t, n) {
                        var r, i;
                        return ! n.collapsed && (r = N(n), C(r)) ? W(V(r)) : (i = B(e, n), t(i) ? W(V(i.getNode( - 1 == e))) : void 0)
                    }
                    function $() {
                        function e(e, t) {
                            var n = t(_());
                            n && !e.isDefaultPrevented() && (e.preventDefault(), v(n))
                        }
                        function t(e) {
                        ...
                        function r(e, t, n) {
                            return n.collapsed ? !1 : h.reduce(n.getClientRects(),
                            function(n, r) {
                        ...
                        function i() {
                            ...
                            b(r) && f(r) && c.dom.isEmpty(r) && (e = c.dom.create("br", {
                                "data-mce-bogus": "1"
                            }), c.$(r).empty().append(e), c.selection.setRng(n.before(e).toRange()))
                        }
                        function o(e) {
                            var t = I();
                            if (t) return "compositionstart" == e.type ? (e.preventDefault(), e.stopPropagation(), void F(t)) : void("&nbsp;" != t.innerHTML && F(t))
                        }
                        function l(e) {
                            var t;
                            switch (e.keyCode) {
                        ...
                        function(e) {
                            var n;
                            if (n = t(e.target)) C(n) ? (e.preventDefault(), Y(T(n), !1)) : r(e.clientX, e.clientY, c.selection.getRng()) || c.selection.placeCaretAt(e.clientX, e.clientY);
                            else {
                                X(),
                                ee.hide();
                                var i = s.closestCaret(G, e.clientX, e.clientY);
                                i && (e.preventDefault(), c.getBody().focus(), v(k(1, i.node, i.before)))
                            }
                        }),
                        c.on("keydown",
                        function(t) {
                            ...
                            case d.BACKSPACE:
                                ...
                                break;
                            default:
                                C(c.selection.getNode()) && t.preventDefault()
                            }
                        }),
                        c.on("keyup compositionstart",
                        function(e) {
                            o(e),
                            l(e)
                        },
                        ...
                        function() {
                            ...
                            C(e) && p.setEditorTimeout(c,
                            function() {
                                v(W(V(e)))
                            })
                        }),
                        c.on("getSelectionRange",
                        function(e) {
                            var t = e.range;
                            if (ne) {
                                if (!ne.parentNode) return void(ne = null);
                                t = t.cloneRange(),
                                t.selectNode(ne),
                                e.range = t
                            }
                        }),
                        c.on("setSelectionRange",
                        function(e) {
                            var t;
                            t = Y(e.range),
                            t && (e.range = t)
                        ...
                        c.on("focus",
                        function() {
                            p.setEditorTimeout(c,
                            function() {
                                c.selection.setRng(W(c.selection.getRng()))
                            })
                        }),
                        m.init(c)
                    }
                    function q() {
                        ...
                        t = ".mce-content-body";
                        e.push(ee.getCss()),
                        e.push(t + " .mce-offscreen-selection {position: absolute;left: -9999999999px;width: 100pxheight: 100px}" + t + " *[contentEditable=false] {cursor: default;}" + t + " *[contentEditable=true] {cursor: text;}")
                    }
                    function j(e) {
                    ...
                    function Y(e, t) {
                        ...
                        if (e.collapsed) {
                            if (X(), !j(e)) {
                                if (f = B(1, e), C(f.getNode())) return k(1, f.getNode(), !f.isAtEnd());
                                if (C(f.getNode(!0))) return k(1, f.getNode(!0), !1)
                            }
                            return null
                        }
                        return s = e.startContainer,
                        l = e.startOffset,
                        u = e.endOffset,
                        3 == s.nodeType && 0 == l && C(s.parentNode) && (s = s.parentNode, l = i.nodeIndex(s), s = s.parentNode),
                        1 != s.nodeType ? (X(), null) : (u == l + 1 && (n = s.childNodes[l]), C(n) ? t !== !1 && (d = c.fire("ObjectSelected", {
                            target: n
                        }), d.isDefaultPrevented()) ? (X(), null) : (o = r("#" + te), 0 === o.length && (o = r('<div data-mce-bogus="all" class="mce-offscreen-selection"></div>').attr("id", te), o.appendTo(c.getBody())), o.empty().append("\xa0").append(n.cloneNode(!0)).append("\xa0").css({
                            top: i.getPos(n, c.getBody()).y
                        }), e = c.dom.createRng(), e.setStart(o[0].firstChild, 1), e.setEnd(o[0].lastChild, 0), c.getBody().focus(), o[0].focus(), a = c.selection.getSel(), a.removeAllRanges(), a.addRange(e), c.$("*[data-mce-selected]").removeAttr("data-mce-selected"), n.setAttribute("data-mce-selected", 1), ne = n, e) : (X(), null))
                    }
                    function X() {
                        ne && (ne.removeAttribute("data-mce-selected"), c.$("#" + te).remove(), ne = null)
                    }
                    function K() {
                        ee.destroy(),
                        ne = null
                    ...
                    Q = y(g, J.next),
                    Z = y(g, J.prev),
                    ee = new o(c.getBody(), f),
                    te = "sel-" + c.dom.uniqueId(),
                    ne,
                    re = c.$;
                    return e.ceFalse && ($(), q()),
                    {
            ...
            r(Ge, [w, g, N, R, A, H, P, Y, J, Q, Z, ee, te, ne, E, d, Se, Be, B, M, Me, h, m, u, Le, Pe, He, We, Ke],
            function(e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, E, N, _, S, k, T, R) {
                function A(e, t, i) {
                    var o = this,
                    a, s;
                ...
                return A.prototype = {
                    render: function() {
                        ...
                        function t() {
                            ...
                            E.isArray(r.plugins) && (r.plugins = r.plugins.join(" ")),
                            P(r.external_plugins,
                            function(e, t) {
                                M.load(t, e),
                                r.plugins += " " + t
                            }),
                        ...
                        if (n.getElement() && w.contentEditable) {
                            ...
                            B.bind(a, "submit reset", n.formEventDelegate), n.on("reset",
                            function() {
                    ...
                    init: function() {
                        ...
                        if (t.iframeHTML = n.doctype + "<html><head>", n.document_base_url != t.documentBaseUrl && (t.iframeHTML += '<base href="' + t.documentBaseURI.getURI() + '" />'), !w.caretAfter && n.ie7_compat && (t.iframeHTML += '<meta http-equiv="X-UA-Compatible" content="IE=7" />'), t.iframeHTML += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />', !/#$/.test(document.location.href)) for (p = 0; p < t.contentCSS.length; p++) {
                            ...
                            t.iframeHTML += '<link type="text/css" rel="stylesheet" href="' + E._addCacheSuffix(g) + '" />',
                            t.loadedCSS[g] = !0
                        }
                        d = n.body_id || "tinymce",
                    ...
                    initContentBody: function(t) {
                        ...
                        function(e, t) {
                            for (var r = e.length,
                            i, o = n.dom,
                            a, s; r--;) if (i = e[r], a = i.attr(t), s = "data-mce-" + t, !i.attributes.map[s]) {
                        ...
                        n.contentStyles.length > 0 && (m = "", P(n.contentStyles,
                        function(e) {
                            m += e + "\r\n"
                        }), n.dom.addStyle(m)),
                        P(n.contentCSS,
                        ...
                        r.auto_focus && N.setEditorTimeout(n,
                        function() {
                            var e;
                    ...
                    focus: function(e) {
                        ...
                        c;
                        if (!e) {
                            if (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), c = t(r.getNode()), n.$.contains(l, c)) return c.focus(),
                            r.normalize(),
                            void n.editorManager.setActive(n);
                    ...
                    execCallback: function(e) {
                        ...
                        "string" == typeof n && (r = n.replace(/\.\w+$/, ""), r = r ? F(r) : 0, n = F(n), t.callbackLookup = t.callbackLookup || {},
                        t.callbackLookup[e] = {
                            func: n,
                            scope: r
                        }),
                    ...
                    getParam: function(e, t, n) {
                        ...
                        i;
                        return "hash" === n ? (i = {},
                        "string" == typeof r ? P(r.indexOf("=") > 0 ? r.split(/[;,](?![^=;,]*(?:[;,]|$))/) : r.split(","),
                        function(e) {
                            e = e.split("="),
                    ...
                    save: function(e) {
                        ...
                        r = e.content,
                        /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r: (t.inline || (n.innerHTML = r), (i = B.getParent(t.id, "form")) && P(i.elements,
                        function(e) {
            ...
            function(e, t, n) {
                function r(e) {
                    ...
                    function f(r) {
                        var f = r.editor;
                        f.on("init",
                        function() { (f.inline || n.ie) && ("onbeforedeactivate" in document && n.ie < 9 ? f.dom.bind(f.getBody(), "beforedeactivate",
                            function(e) {
                                if (e.target == f.getBody()) try {
                                    f.lastRng = f.selection.getRng()
                                } catch(t) {}
                            }) : f.on("nodechange mouseup keyup",
                            function(e) {
                                var t = l();
            ...
            function(e, t, n, r, i, o, a, s, l, c) {
                ...
                function d(e, n) {
                    n !== x && (n ? t(window).on("resize", u) : t(window).off("resize", u), x = n)
                }
                function f(e) {
                    var t = C.editors,
                    n;
                ...
                function h(e) {
                    return e && !(e.getContainer() || e.getBody()).parentNode && (f(e), e.unbindAllNativeEvents(), e.destroy(!0), e = null),
                    e
                }
                var p = n.DOM,
                m = o.explode,
                ...
                return C = {
                    ...
                    setup: function() {
                        ...
                        i = o.suffix;
                            ...
                            for (var s = document.getElementsByTagName("script"), l = 0; l < s.length; l++) {
                                ...
                                if (/tinymce(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(a)) { - 1 != u.indexOf(".min") && (i = ".min"),
                    ...
                    init: function(t) {
                        ...
                        function r(e) {
                            var n = t[e];
                            if (n) return n.apply(c, Array.prototype.slice.call(arguments, 2))
                        }
                        function i(e, t) {
                        ...
                        function s(e) {
                            var t, n = [];
                            switch (e.types ? g(e.types,
                            function(e) {
                                n = n.concat(p.select(e.selector))
                            }) : e.selector ? n = p.select(e.selector) : e.target && (n = [e.target]), e.mode) {
                            case "exact":
                                t = e.elements || "",
                                t.length > 0 && g(m(t),
                                function(e) {
                                    var t; (t = p.get(e)) ? n.push(t) : g(document.forms,
                                    function(t) {
                                        g(t.elements,
                                        function(t) {
                        ...
                        function l(i, a) {
                            function l(t, n, r) {
                                if (!h(c.get(t))) {
                                    ...
                                    d.push(o),
                                    o.on("init",
                                    function() {++u === f.length && i(d)
                                    }),
                                    o.targetElm = o.targetElm || r,
                                    o.render()
                                }
                            }
                            var u = 0,
                            d = [],
                            f;
                            return p.unbind(window, "ready", a),
                            r("onpageload"),
                            f = s(t),
                            t.types ? void g(t.types,
                            function(e) {
                                o.each(f,
                                function(r) {
                                    return p.is(r, e.selector) ? (l(n(r), v({},
                                    t, e), r), !1) : !0
                                })
                            }) : void g(f,
                            function(e) {
                    ...
                    remove: function(e) {
                        ...
                        n, r = t.editors,
                        i; {
                            if (e) return "string" == typeof e ? (e = e.selector || e, void g(p.select(e),
                            function(e) {
                                i = r[e.id],
                                i && t.remove(i)
                ...
                var n = {
                    send: function(e) {
                        ...
                        if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = e.async === !1 ? !1 : !0, e.data = e.data || "", n.fire("beforeInitialize", {
                            ...
                            if (i.overrideMimeType && i.overrideMimeType(e.content_type), i.open(e.type || (e.data ? "POST": "GET"), e.url, e.async), e.crossDomain && (i.withCredentials = !0), e.content_type && i.setRequestHeader("Content-Type", e.content_type), e.requestheaders && t.each(e.requestheaders,
                            function(e) {
            ...
            function(e) {
                return e.extend({
                    ...
                    bindStates: function() {
                        ...
                        n = t.$,
                        r = t.classPrefix + "txt";
                        return t.state.on("change:text",
                        function(t) {
                            e(t.value)
                        }),
                        t.state.on("change:icon",
                        function(n) {
                            var r = n.value,
                            i = t.classPrefix;
                            t.settings.icon = r,
            ...
            function(e) {
                return e.extend({
                    ...
                    bindStates: function() {
                        ...
                        t.state.on("change:checked change:value",
                        function(n) {
                            t.fire("change"),
                            e(n.value)
                        }),
                ...
                return e.extend({
                    init: function(e) {
                        ...
                        function(n) {
                            var i = n.target,
                            o = t.getEl();
                            if (r.contains(o, i) || i == o) for (; i && i != o;) i.id && -1 != i.id.indexOf("-open") && (t.fire("action"), e.menu && (t.showMenu(), n.aria && t.menu.items()[0].focus())),
                            i = i.parentNode
                        }),
                        t.on("keydown",
                        function(e) {
                    ...
                    postRender: function() {
                        var e = this;
                        return r(this.getEl("inp")).on("change",
                        function(t) {
            ...
            function(e, t) {
                return e.extend({
                    postRender: function() {
                        ...
                        var n = this,
                        r = t.activeEditor;
                        return r.settings.elementpath !== !1 && (n.on("select",
                        function(e) {
                            r.focus(),
            ...
            function(e) {
                return e.extend({
                    recalc: function(e) {
                        ...
                        y > E && (E = y);
                        if (x = {},
                        0 > d ? x[_] = i[_] - d + i[A] : x[_] = i[R] - d + i[A], x[P] = E + i[I], x[B] = i[R] - d, x[F] = E, x.minW = W(x.minW, i.maxW), x.minH = W(x.minH, i.maxH), x.minW = z(x.minW, i.startMinWidth), x.minH = z(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                            for (C = d / u, t = 0, n = v.length; n > t; t++) h = v[t],
                            p = h.layoutRect(),
                            b = p[k],
                            y = p[_] + p.flex * C,
                            y > b ? (d -= p[k] - p[_], u -= p.flex, p.flex = 0, p.maxFlexSize = b) : p.maxFlexSize = 0;
                            for (C = d / u, w = o[T], x = {},
                            0 === u && ("end" == l ? w = d + o[T] : "center" == l ? (w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])) : "justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[D] = o[H], t = 0, n = r.length; n > t; t++) h = r[t],
                            p = h.layoutRect(),
                            y = p.maxFlexSize || p[_],
                            "center" === s ? x[D] = Math.round(i[M] / 2 - p[L] / 2) : "stretch" === s ? (x[L] = z(p[P] || 0, i[M] - o[H] - o[O]), x[D] = o[H]) : "end" === s && (x[D] = i[M] - p[L] - o.top),
                            p.flex > 0 && (y += p.flex * C),
                            x[N] = y,
                            x[S] = w,
                            h.layoutRect(x),
            ...
            function(e, t, n, r, i, o) {
                function a(e) {
                    ...
                    function o(t) {
                        return function() {
                            var n = this;
                            e.formatter ? e.formatter.formatChanged(t,
                            function(e) {
                                n.active(e)
                            }) : e.on("init",
                            function() {
                                e.formatter.formatChanged(t,
                                function(e) {
                                    n.active(e)
                                })
                            })
            ...
            function(e) {
                return e.extend({
                    recalc: function(e) {
                        ...
                        T -= (d > 0 ? y: 0) + N[d];
                        for (R = o.innerH - g.top - g.bottom, E = 0, f = 0; n > f; f++) E += _[f] + (f > 0 ? b: 0),
                        R -= (f > 0 ? b: 0) + _[f];
                        if (w += g.left + g.right, E += g.top + g.bottom, l = {},
                        l.minW = w + (o.w - o.innerW), l.minH = E + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
                            ...
                            var M = 0,
                            L = t.flexWidths;
                            if (L) for (d = 0; d < L.length; d++) M += L[d];
                            else M = r;
                            var P = T / M;
                            for (d = 0; r > d; d++) N[d] += L ? L[d] * P: P;
                            for (p = g.top, f = 0; n > f; f++) {
                                for (h = g.left, s = _[f] + D, d = 0; r > d && (B = A ? f * r + r - 1 - d: f * r + d, u = i[B], u); d++) m = u.settings,
                                c = u.layoutRect(),
                                a = Math.max(N[d], c.startMinWidth),
                                c.x = h,
                                c.y = p,
                                v = m.alignH || (C ? C[d] || C[0] : null),
                                "center" == v ? c.x = h + a / 2 - c.w / 2 : "right" == v ? c.x = h + a - c.w: "stretch" == v && (c.w = a),
                                v = m.alignV || (x ? x[d] || x[0] : null),
                                "center" == v ? c.y = p + s / 2 - c.h / 2 : "bottom" == v ? c.y = p + s - c.h: "stretch" == v && (c.h = s),
                                u.layoutRect(c),
                                h += a + y,
                                u.recalc && u.recalc();
                                p += s + b
                ...
                var i = e.extend({
                    ...
                    showMenu: function() {
                        ...
                        return e.menu && e.menu.visible() ? e.hideMenu() : (e.menu || (n = e.state.get("menu") || [], n.length ? n = {
                            type: "menu",
                            items: n
                        }: n.type = n.type || "menu", n.renderTo ? e.menu = n.parent(e).show().renderTo() : e.menu = t.create(n).parent(e).renderTo(), e.fire("createmenu"), e.menu.reflow(), e.menu.on("cancel",
                        function(t) {
                ...
                return e.extend({
                    ...
                    renderHtml: function() {
                        function e(e) {
                            ...
                            e = e.split("+"), t = 0; t < e.length; t++) r = i[e[t].toLowerCase()],
                            r && (e[t] = r);
                            return e.join("+")
                        }
                        var t = this,
            ...
            function(e, t, n, r) {
                return e.extend({
                    ...
                    init: function(e) {
                        var t = this;
                        if (e.autohide = !0, e.constrainToViewport = !0, "function" == typeof e.items && (e.itemsFactory = e.items, e.items = []), e.itemDefaults) for (var n = e.items,
                        i = n.length; i--;) n[i] = r.extend({},
                        e.itemDefaults, n[i]);
                        t._super(e),
                        t.classes.add("menu")
                    },
                    ...
                    load: function() {
                        ...
                        i && (t.throbber || (t.throbber = new n(t.getEl("body"), !0), 0 === t.items().length ? (t.throbber.show(), t.fire("loading")) : t.throbber.show(100,
                        function() {
                            t.items().remove(),
                            t.fire("loading")
                    ...
                    init: function(e) {
                        function t(r) {
                            for (var a = 0; a < r.length; a++) {
                                if (i = r[a].selected || e.value === r[a].value) return o = o || r[a].text,
                                n.state.set("value", r[a].value),
                                !0;
            ...
            function(e, t, n) {
                ...
                function i(e, t) {
                    var r, i, o, a, s;
                    "v" == e.settings.orientation ? (a = "top", o = "height", i = "h") : (a = "left", o = "width", i = "w"),
                ...
                return e.extend({
                    ...
                    postRender: function() {
                        ...
                        c = e._maxValue,
                        s = e.value(),
                        "v" == e.settings.orientation ? (d = "screenY", f = "top", h = "height", p = "h") : (d = "screenX", f = "left", h = "width", p = "w"),
                        e._super(),
                        e._dragHelper = new t(e._id, {
                            ...
                            start: function(t) {
                                ...
                                u = (e.layoutRect()[p] || 100) - n.getSize(e.getEl("handle"))[h],
                                e.fire("dragstart", {
                                    value: s
                                })
                            },
                            drag: function(t) {
                                ...
                                s = l + a / u * (c - l),
                                e.value(s),
                                e.tooltip().text("" + e.settings.previewFilter(s)).show().moveRel(h, "bc tc"),
                                e.fire("drag", {
                                    value: s
                                })
                            },
            ...
            a([l, c, u, d, f, h, m, g, v, y, C, w, E, N, T, A, B, D, M, L, P, H, I, F, j, Y, J, Q, te, ne, re, ie, ae, le, ce, he, pe, me, ge, ve, ye, be, Ce, xe, we, Ee, Ne, _e, Se, ke, Te, Re, Ae, Be, Le, He, Ge, Je, Qe, Ze, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, Ct, xt, wt, Et, Nt, _t, St, kt, Tt, Rt, At, Bt, Dt, Mt, Lt, Pt, Ht, Ot, It, Ft, zt, Wt, Vt, Ut, $t, qt, jt])
        } (this);