...
(function($) {
    ...
    view = {
        ...
        // make the notebook node title
        makeDOMNodeIcon: function(html, setting, node) {
            var nameStr = data.getNodeName(setting, node),
            name = setting.view.nameIsHTML ? nameStr: nameStr.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
            console.log(node);
            if(node.NotebookId == "0") { // All
                html.push("<span id='", node.tId, consts.id.ICON, "' title='' treeNode", consts.id.ICON, " class='", view.makeNodeIcoClass(setting, node), "' style='", view.makeNodeIcoStyle(setting, node), "'></span><span class='tree-title' id='", node.tId, consts.id.SPAN, "'>", '<i class="fa fa-file-text" aria-hidden="true"></i>  ',name, "</span>")
                
            }
            else if(node.NotebookId == "-1") { // Trash
                html.push("<span id='", node.tId, consts.id.ICON, "' title='' treeNode", consts.id.ICON, " class='", view.makeNodeIcoClass(setting, node), "' style='", view.makeNodeIcoStyle(setting, node), "'></span><span class='tree-title' id='", node.tId, consts.id.SPAN, "'>", '<i class="fa fa-trash" aria-hidden="true"></i>  ', name, "</span>")
            }
            else {
        ...
        // make the notebook node outer dom element
        ...
        // make the notebook node name dom element
    ...
    $.fn.zTree = {
        ...
        newinit: function(obj, zSetting, zNodes) {
			var setting = tools.clone(_setting);
			$.extend(true, setting, zSetting);
			setting.treeId = obj.attr("id");
			setting.treeObj = obj;
