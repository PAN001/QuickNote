...
var Resize = {
    ...
    setMediaWidth: function(xClient) {
        var o = this;
        if (xClient>= window.innerWidth*0.4 && xClient <=  window.innerWidth*0.8){
...
//        })
        ...
        bootbox.confirm("Please confirm to delete this tag", function(result) {
            if(result) {
                var t = e.Item;
...
//
    ...
    var temp = clone(o);
    e.tree = $.fn.notebookZTree.init($("#notebookList"), e.getTreeSetting(), o); // initialize the zTree
...
Share.deleteUserShareNoteAndNotebook = function(e) {
    ...
    bootbox.confirm("Please confirm to delete the share user: " + thisShareNotebookTitle, function(result) {
        if(result) {
            $(e).parent().remove();
            thisUserShareNotebooks.splice(deleteIndex, 1);
            shareNotebooks[thisFromUserId] = thisUserShareNotebooks;
